...
return [
   ...
   */
   'user_models' => [
      'users' => \App\Models\wingu\wp_user::class,
   ],
   ...
   */
   'models' => [
      ...
      'role' => \App\Models\wingu\laratrust\Role::class,

      'permission' => \App\Models\wingu\laratrust\Permission::class,

      /**
      * Will be used only if the teams functionality is enabled.
      */
      'team' => \App\Models\wingu\laratrust\Team::class,
   ],
   ...
   */
   'tables' => [
      ...
      */
      ...
      'role_user' => 'wp_role_user',

      'permission_user' => 'wp_permission_user',

      'permission_role' => 'wp_permission_role',
   ],
