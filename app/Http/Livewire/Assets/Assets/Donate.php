...
class Donate extends Component
{
   ...
   public $editMode = 'off';
   public $editCode;
   public $action_date,$action_to,$note,$cost,$deductible;
   ...
   public function render()
   {
      ...
      return view('livewire.assets.assets.donate', compact('events'));
   }
   ...
   public function edit($editID){
      ...
      $this->deductible  = $edit->deductible;
      $this->cost        = $edit->cost;
   ...
   public function update(){
      ...
      $edit->deductible      = $this->deductible;
      $edit->cost            = $this->cost;
