...
class stockcontrolController extends Controller
{
   ...
   */
   public function index(){
      ...
      $lpos	= lpo::join('suppliers','suppliers.id','=','lpo.supplierID')
							...
							->get();
		return view('app.poa.products.stock.index', compact('lpos'));
   }
   ...
   */
   public function order(){
      ...
      return view('app.poa.products.stock.order', compact('suppliers','products','status'));
   }
   ...
   */
   public function store(Request $request)
   {
      ...
      $store->created_by 	    = Auth::user()->id;
		...
		return redirect()->route('poa.product.stock.control');
   ...
   */
	public function show($id){
		...
		return view('app.poa.products.stock.show', compact('supplier','lpo','products','count','filec','files','persons','template'));
	}
   ...
   */
	public function edit($id)
	{
		...
		return view('app.poa.products.stock.edit', compact('suppliers','supplier','taxed','count','lpo','products','lpoproducts','taxs'));
	}
	...
	*/
	public function mail($id){
      ...
      $pdf->save($directory.$lpo->prefix.$lpo->lpo_number.'.pdf');
		...
		return view('app.poa.products.stock.mail', compact('lpo','files','contacts','supplier'));
	}
