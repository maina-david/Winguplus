...
class productsController extends Controller
{
   ...
   **/
   public function index(){
      return view('app.pos.products.products.index');
   }
   ...
   **/
   public function create(){
      ...
      $tags = tags::where('business_code',Auth::user()->business_code)
                  ->orderBy('id','desc')
                  ->pluck('name','name');
      ...
      $brands = brand::where('business_code',Auth::user()->business_code)
                        ->pluck('name','name')
                        ->prepend('Choose brand','');

      return view('app.pos.products.products.create', compact('categories','tags','suppliers','brands'));
   }
   ...
   */
   public function store(Request $request)
   {
     ...
     $product_inventory->save();
      ...
      return redirect()->route('pos.products.price', $productCode);
   }
   ...
   */
   public function details($code)
   {
      $details = product_information::join('wp_business','wp_business.business_code','=','fn_product_information.business_code')
                     ...
                     ->select('*','fn_product_information.created_by as creator')
   ...
   */
   public function edit($productCode)
   {
     ...
     return view('app.pos.products.products.edit', compact('product','categories','tags','productCode','suppliers','brands','jointTags','jointCategories'));
   }
   ...
   */
   public function update(Request $request, $code)
   {
      ...
      $product = product_information::where('product_code',$code)->where('business_code',Auth::user()->business_code)->first();
   ...
   */
   public function description($code){
      $product = product_information::where('product_code',$code)->where('business_code',Auth::user()->business_code)->first();
      return view('app.finance.products.description', compact('product','code'));
   }
   ...
   * @return \Illuminate\Http\Response
   */
   public function description_update(Request $request,$code){
