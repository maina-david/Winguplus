...
class b2cController extends Controller
{
   ...
   * */
   public function paymentrequest($businessID)
   {
      ...
      $curl_post_data = [
         'InitiatorName' => $data['title'],
         'SecurityCredential' => $this->MpesaPassword(),
         'CommandID' => 'SalaryPayment',
         'Amount' => 5, //amount sent
         'PartyA' => 174379, //paybill number
         'PartyB' => '254743378506', //receiver
         'Remarks' => 'winguPlus daraja B2C',
         'QueueTimeOutURL' => $data['cancel_url'],
         'ResultURL' => $data['callback_url'],
         'Occasion' => '623ghdsfwer' //Optional user system transactionID
      ];
