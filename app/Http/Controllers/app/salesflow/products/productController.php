...
class productController extends Controller{
   ...
   */
   ...
   {
      return view('app.salesflow.products.index');
   }
   ...
   */
   public function create()
   {
      ...
      return view('app.salesflow.products.create', compact('categories','suppliers','brands'));
   }
  ...
  public function store(Request $request)
  {
     ...
     //recorded activity
     $activity     = '<a href="#">'.Auth::user()->name.'</a> has <b>added</b> a new product <a href="'.route('salesflow.products.details',$productCode).'">'.$request->product_name.'</a>';
     $module       = 'Sales Flow';
     $section      = 'Products';
     $action       = 'Create';
     ...
     return redirect()->route('salesflow.products.edit', $productCode);
  }
  ...
  public function details($code)
  {
     ...
     return view('app.salesflow.products.details.show', compact('details'));
  }
  ...
  */
  public function edit($productCode)
  {
     ...
     return view('app.salesflow.products.edit', compact('product','categories','tags','productCode','suppliers','brands','jointTags','jointCategories'));
  }
  ...
  */
  public function update(Request $request, $productCode)
  {
     ...
     //recorded activity
     $activity     = '<a href="#">'.Auth::user()->name.'</a> has <b>updated</b> <a href="'.route('salesflow.products.details',$productCode).'">'.$request->product_name.' product</a>';
     $module       = 'Sales Flow';
     $section      = 'Products';
     $action       = 'Create';
     $activityCode = $productCode;
  ...
  */
  public function description($productCode){
     ...
     return view('app.salesflow.products.description', compact('product','productCode'));
  }
...
* product price
  ...
  */
  public function price($productCode)
  {
     ...
     return view('app.salesflow.products.price', compact('prices','productCode','product','outlets','defaultPrice','mainBranch'));
  }
  ...
  */
  public function destroy($code)
  {
     ...
     if($invoice == 0){
        ...
        //delete categories
        product_category_product_information::where('product_code',$code)->delete();
  ...
  */
  public function category(){
     return view('app.salesflow.products.categories');
  }
}
