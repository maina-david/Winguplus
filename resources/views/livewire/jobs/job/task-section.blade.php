<div>
   <div class="row">
      <div class="col-md-12 mb-3">
         <div class="row">
            <div class="col-md-8">
               <h4 class="font-weight-bold"><i class="fal fa-check-square"></i> Job Tasks | <a href="{!! route('job.dashboard',$this->jobCode) !!}">{!! $job->job_title !!}</a> | {!! $sectionDetails->title !!}</h4>
            </div>
            <div class="col-md-2">
      ...
      @if($sections->count() > 0)
         <div class="col-md-12">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
               <li class="nav-item">
                  <a class="nav-link" href="{!! route('job.task',$this->jobCode) !!}">General</a>
               </li>
               @foreach($sections as $sec)
                  ...
                  @endphp
                  <li class="nav-item">
                     <a class="nav-link {!! Nav::isResource($url) !!}" href="{!! route('job.task.section',[$this->jobCode,$sec->section_code,$url]) !!}">{!! $sec->title !!}</a>
                  </li>
               @endforeach
            </ul>
         </div>
      ...
      <div class="col-md-12">
         <a class="btn btn-sm btn-danger float-right" data-toggle="modal" data-target="#delete" wire:click="remove_section({{$getSectionCode}})" href="#"><i class="fas fa-trash-alt"></i> Delete Section</a>
         <a class="btn btn-sm btn-primary float-right mr-2" wire:click="edit_section({{$getSectionCode}})" data-toggle="modal" data-target="#edit-section" href="#"><i class="fas fa-edit"></i> Edit Section</a>
      </div>
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="form-group">
                     ...
                     @error('section_title')<span class="error text-danger">{{$message}}</span>@enderror
                  </div>
               </div>
               <div class="modal-footer">
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-footer justify-content-center">
                     ...
                     @if($deleteType == 'section')
                        <button type="button" class="btn btn-danger" wire:click="delete_section({{$getSectionCode}})">Delete</button>
                     @endif
                     @if($deleteType == 'task')
