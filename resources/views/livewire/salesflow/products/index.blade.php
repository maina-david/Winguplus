               ...
               @foreach($products as $key => $product)
                  @if(Auth::user()->business_code == $product->businessID)
                     <tr>
                        ...
                        <td>
                           <a href="{{ route('salesflow.products.details', $product->productCode) }}" class="btn btn-warning btn-sm"><i class="fas fa-eye"></i></a>
                           <a href="{{ route('salesflow.products.edit', $product->productCode) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                           <a href="{!! route('salesflow.products.destroy', $product->productCode) !!}" class="btn btn-danger delete btn-sm"><i class="fas fa-trash"></i></a>
                        </td>
                     </tr>
                  @endif
               @endforeach
