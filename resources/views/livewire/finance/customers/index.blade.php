                  ...
                  @if($contact->business_code == Auth::user()->business_code)
                     @if($contact->customerCode)
                        <tr>
                           ...
                           <td>{!! $contact->currency !!}{!! number_format(Finance::customer_invoices($contact->customerCode)->sum('balance')) !!}</td>
                           <td>
                              <div class="btn-group">
                                 ...
                                 <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{ route('finance.contact.edit',$contact->customerCode) }}"><i class="fas fa-edit"></i> Edit</a></li>
                                    <li><a href="{!! route('finance.contact.delete',$contact->customerCode) !!}" class="delete"><i class="fal fa-trash-alt"></i> Delete</a></li>
                                 </ul>
                              </div>
                           </td>
                        </tr>
