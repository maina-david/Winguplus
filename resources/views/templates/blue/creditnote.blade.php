...
<html lang="en">
   <head>
      <meta charset="utf-8">
      <title>{!! Finance::creditnote()->prefix !!}00{!! $details->creditnote_number !!}</title>
      <link rel="stylesheet" href="{!! url('/') !!}/resources/views/templates/invoices/temp03/print/style.css" media="all" />
   </head>
   <body>
      <header class="clearfix">
         <div id="logo">
            @if (Limitless::business(Auth::user()->businessID)->logo != "")
               <img src="{!! url('/') !!}/storage/files/business/{!! Limitless::business(Auth::user()->businessID)->email !!}/images/{!! Limitless::business(Auth::user()->businessID)->logo !!}">
            @endif
         </div>
         <div id="company">
      ...
      <main>
         <div id="details" class="clearfix">
            ...
            <div id="invoice">
               ...
               @endif
               <h3>#{!! Finance::creditnote()->prefix !!}00{!! $details->creditnote_number !!}</h3>
               <div class="date"><b>Date of Invoice:</b> {!! date('F j, Y',strtotime($details->creditnote_date)) !!}</div>
               <div class="date"><b>Due Date:</b> {!! date('F j, Y',strtotime($details->creditnote_due)) !!}</div>
            </div>
         </div>
         <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tfoot>
               ...
               @if(Finance::creditnote()->show_discount_tab == 'Yes')
                  <tr>
                     <td colspan="2"></td>
               ...
               @endif
               @if(Finance::creditnote()->show_tax_tab == 'Yes')
                  <tr>
                     <td colspan="2"></td>
         ...
         @if($details->creditnote_note != "")
            <div class="notice">
               Client Note
               {!! $details->creditnote_note !!}
            </div>
         @endif
         @if($details->terms != "")
            <div class="notice">
