<div class="row mt-3">
   <div class="col-md-12">
      <div class="card">
         ...
         <div class="card-body">
            <form  method="POST" action="{!! route('finance.customers.statement.send',$customerCode) !!}" enctype="multipart/form-data">
               @csrf
               <div class="form-group">
                  <label for="">Subject</label>
                  {!! Form::text('subject',null,['class'=>'form-control','placeholder'=>'Enter subject','required'=>'']) !!}
                  <input type="hidden" name="customerCode"value="{!! $customerCode  !!}" required>
               </div>
               <div class="form-group">
                  <label for="">Email
               ...
               <div class="form-group">
                  <p>
                     view attachment <br>
                     <a href="{!! url('/') !!}/businesses/{!! Wingu::business()->business_code !!}/finance/statement/{!! $client->customer_code !!}-@php echo date('Y') @endphp.pdf" target="_blank" id="preview"> Preview current Attached Statement</a>
                  </p>
               </div>
