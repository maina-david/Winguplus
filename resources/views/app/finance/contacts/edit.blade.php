	...
	<div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         <li class="breadcrumb-item"><a href="{!! route('finance.index') !!}">Finance</a></li>
			...
			<li class="breadcrumb-item"><a href="{{ route('finance.contact.show', $contact->customer_code) }}">{!! $contact->customer_name !!}</a></li>
      ...
      {!! Form::model($contact, ['route' => ['finance.contact.update',$contact->customer_code], 'method'=>'post','enctype'=>'multipart/form-data']) !!}
         {!! csrf_field() !!}
         <div class="row">
            <div class="col-md-6">
...
@section('scripts')
	<script>
      ...
      $("#set-post-thumbnail").click(function() {
		...
		$(".select2").select2().val({!! json_encode($jointcategories) !!}).trigger('change');
	</script>
@endsection
