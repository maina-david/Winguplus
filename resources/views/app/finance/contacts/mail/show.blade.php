	...
	<div id="content" class="content">
		<div class="row">
			<div class="col-md-3">
               ...
               @if($client->customer_logo != "")
						<img src="{!! asset('businesses/'.Wingu::business(Auth::user()->businessID)->businessID.'/customer/'.$client->customer_code.'/images/'.$client->customer_logo) !!}" alt="" style="width:90px;height:90px" class="rounded-circle">
					@else
					...
					<a href="{{ route('finance.contact.edit', $client->cid) }}" class="btn btn-success btn-xs waves-effect mb-2 waves-light"><i class="fal fa-edit"></i> Edit</a>
					<a href="{{ route('finance.customer.send', $client->cid) }}" class="btn btn-primary btn-xs waves-effect mb-2 waves-light"><i class="fal fa-paper-plane"></i> Send Email</a>
			...
			<div class="col-md-9">
				<div class="row mb-3">
                  ...
                  <div class="float-right">
							<a href="{{ route('finance.contact.edit', $client->cid) }}" class="btn btn-white"><i class="fas fa-edit"></i> Edit</a>
							<a href="{{ route('finance.customer.send', $client->cid) }}" class="btn btn-white"><i class="fal fa-paper-plane"></i> Send Mail</a>
   						<div class="btn-group">
   						...
   						<div class="btn-group">
								...
								<ul class="dropdown-menu">
									...
									<li class="divider"></li>									
									<li><a href="{!! route('finance.contact.delete', $client->cid) !!}"><i class="fas fa-trash"></i> Delete</a></li>
								</ul>
							</div>
