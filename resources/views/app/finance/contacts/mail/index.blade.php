               ...
               <li class="list-group-item">
                  <div class="media">
                     <div class="pull-left">
                        <div class="thumb">
                           @if($client->image != "")
                              <img src="{!! asset('businesses/'.Wingu::business()->business_code.'/customer/'.$client->customer_code.'/images/'.$client->image) !!}" alt="" style="width:50px;height:50px" class="rounded-circle">
                           @else
                     ...
                     <div class="media-body">
                        <div class="media-heading">
                           <a href="{!! route('finance.customer.mail.details',[$mail->mail_code,$customerCode]) !!}" class="m-r-10">{!! $mail->names !!}</a>
                           @if($mail->status == "Sent")
                        ...
                        <p class="msg">
                           ...
                           @if($mail->view_count)
                              ...
                              <span class="text-pink"><b>View Date</b>
                                 <br>
                                 <i class="text-primary">{!! date('F jS, Y @ h:i:s A',strtotime($mail->date_view)) !!}</i>
                              </span>
                              <br>
                              <span class="text-info">View Count : {!! $mail->view_count !!}</span>
                           @endif
                        </p>
                     </div>
                  </div>
