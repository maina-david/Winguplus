@extends('layouts.app')
{{-- page header --}}
@section('title','Add New |  New Purchase Order')
...
@section('content')
   <div id="content" class="content">
      ...
      {!! Form::open(array('route' => 'finance.lpo.store', 'enctype'=>'multipart/form-data','method' => 'post','autocomplete' => 'off')) !!}
         @csrf
         <div class='row'>
         ...
         <div class='row mt-3'>
            <div class="col-md-6 mt-3">
               ...
               <textarea name="customer_note" class="form-control tinymcy" rows="8" cols="80">{!! Finance::lpo()->default_customer_notes !!}</textarea>
            </div>
            <div class="col-md-6 mt-3">
               <label for="">Terms & Conditions</label>
               <textarea name="terms" class="form-control tinymcy" rows="8" cols="80">{!! Finance::lpo()->default_terms_conditions !!}</textarea>
            </div>
