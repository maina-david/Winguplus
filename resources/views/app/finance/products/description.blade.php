@extends('layouts.app')
{{-- page header --}}
@section('title','Product Description | Finance')
...
@section('content')
   <div id="content" class="content">
      ...
      <div class="row">
         ...
         <div class="col-md-9">
            {!! Form::model($product, ['route' => ['finance.description.update',$productCode], 'method'=>'post','data-parsley-validate' => '','enctype'=>'multipart/form-data']) !!}
               {!! csrf_field() !!}
