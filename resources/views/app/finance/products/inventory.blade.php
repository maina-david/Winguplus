         ...
         <div class="panel panel-default">
            <div class="panel-body">
               <div class="col-md-12 mt-3">
                  {!! Form::model($product, ['route' => ['finance.inventory.settings.update',$productCode],'class' => 'row', 'method'=>'post','enctype'=>'multipart/form-data']) !!}
                     @csrf
                     <div class="col-md-6">
                           ...
                           <table class="table table-striped">
                              ...
                              <tbody>
                                 @foreach($inventories as $inventory)
                                    <form action="{!! route('finance.inventory.update',[$inventory->id,$productCode]) !!}" method="POST" >
                                       @csrf
                                       <tr>
                                          <td>
