                           ...
                           <tbody>
                              @foreach ($taxes as $tax)
                                 <tr>
                                    ...
                                    <td>
                                       <a href="javascript:;" class="btn btn-sm btn-primary edit-taxes" id="{!! $tax->tax_code !!}"><i class="fas fa-edit"></i> Edit</a>
                                       <a href="{!! route('finance.settings.delete', $tax->tax_code) !!}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Delete</a>
                                    </td>
                                 </tr>
                              @endforeach
                           </tbody>
