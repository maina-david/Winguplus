@extends('layouts.app')
{{-- page header --}}
@section('title','Inventory Summary | Finance Reports')
{{-- page styles --}}
@section('stylesheet')
   <style>
      button {
...
@section('content')
      ...
      <div class="row">
         <div class="col-md-12 mb-3">
            <div class="row">
               ...
               <div class="col-md-4">
                  <a href="{!! route('finance.report.inventory.summary.extract') !!}" target="_blank" class="btn btn-pink pull-right"><i class="fas fa-file-pdf"></i> Export in pdf</a>
                  <a href="{!! route('finance.report.inventory.summary.extract') !!}" target="_blank" class="btn btn-pink pull-right mr-2"><i class="fas fa-print"></i> Print</a>
                     ...
                     <tbody>
                        @foreach($products as $product)
                           <tr>
                              ...
                              <td><i>{!! Finance::product_sales_report($product->product_code)->quantity !!}</i></td>
                              <td><i>{!! $product->current_stock !!}</i></td>
                           </tr>
                        @endforeach
                     </tbody>
                  </table>
    ...
    <!-- Modal -->
    <form action="{!! route('finance.report.inventory.summary') !!}" method="GET" autocomplete="off">
