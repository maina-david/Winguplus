@extends('layouts.app')
{{-- page header --}}
@section('title','Product Sales Report | Finance Reports')
...
@section('content')
	<div id="content" class="content">
      ...
      <div class="col-md-12 mb-3">
         <div class="row">
            ...
            <div class="col-md-4">
               <a href="{!! route('finance.report.inventory.sale.summary.extract',[$to,$from]) !!}" target="_blank" class="btn btn-pink pull-right"><i class="fas fa-file-pdf"></i> Export in pdf</a>
               <a href="{!! route('finance.report.inventory.sale.summary.extract',[$to,$from]) !!}" target="_blank" class="btn btn-pink pull-right mr-2"><i class="fas fa-print"></i> Print</a>
                  ...
                  <tbody>
                     @foreach($products as $product)
                        <tr>
                           ...
                           <td><center><b>{!! $product->code !!} {!! number_format($product->total) !!}</b></center></td>
                        </tr>
                     @endforeach
                     {{-- <tr>
                        <td><b>Total</b></td>
                        <td><center>{!! $countInvoice !!}</center></td>
                        <td><center><b>{!!  number_format($products->sum('total')) !!} {!! Wingu::currency()->code !!}</b></center></td>
                     </tr> --}}
                  </tbody>
               </table>
            </div>
   ...
   <!-- Modal -->
   <form action="{!! route('finance.report.inventory.sale.summary') !!}" method="GET" autocomplete="off">
