@extends('layouts.app')
@section('title','winguPlus Applications')
@section('stylesheet')
                  ...
                  @foreach($cart as $item)
                     <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                           ...
                           <a href="{!! route('application.remove.cart',$item->module_code) !!}" class="delete"><span class="badge badge-danger">Remove</span></a>
                        </div>
               ...
               @foreach($applications as $app)
                  @if($app->id != 9)
                     @if($app->status == 15 || $app->status == 24)
                        @if(Wingu::check_business_modules($app->module_code) == 0)
                           <div class="col-md-4">
                              <div class="card">
