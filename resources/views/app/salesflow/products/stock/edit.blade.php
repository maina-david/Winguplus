...
@section('content')
   <div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><a href="{!! route('finance.product.stock.order.show',$lpo->po_code) !!}">{{ Finance::lpo()->prefix }}{!! $lpo->lpo_number !!}</a></li>
      ...
      {!! Form::model($lpo, ['route' => ['finance.product.stock.order.update',$lpo->po_code], 'method'=>'post','enctype'=>'multipart/form-data']) !!}
         @csrf
         <div class='row'>
         ...
         <div class='row'>
            ...
            <div class="col-md-4 col-lg-4">
               <div class="form-group form-group-default">
                  ...
                  {!! Form::date('lpo_date', null, array('class' => 'form-control required', 'placeholder' => 'Enter date','required' => '')) !!}
               </div>
            </div>
            <div class="col-md-4 col-lg-4">
               <div class="form-group form-group-default">
                  <label for="end" class="text-danger">Delivery due * </label>
                  {!! Form::date('lpo_due', null, array('class' => 'form-control required', 'placeholder' => 'Enter date','required' => '')) !!}
               </div>
            </div>
         </div>
                     ...
                     <table class="table table-bordered table-striped" id="invoiceItems">
                        ...
                        <tbody>
                           @foreach($lpoproducts as $product)
                              <tr class="clone-item">
                                 ...
                                 <td>
                                    <input type="number" name="qty[]" value="{{ $product->quantity }}" id="quantity_1" class="form-control changesNo quanyityChange">
                                 </td>
                                 <td>
                                    <input type="number" name="price[]" value="{{ $product->price }}" id="price_1" class="form-control changesNo" autocomplete="off" step="0.01">
                                 </td>
                        ...
                        <tfoot>
                           ...
                           <tr class="table-default">
                              ...
                              <td colspan="3">
                                 <h4 class="text-center">
                                    <input readonly  value="{!! $lpo->total !!}" type="number" class="form-control" id="InvoicetotalAmount" placeholder="Total" step="0.01">
                                 </h4>
                              </td>
                           </tr>
                        </tfoot>
