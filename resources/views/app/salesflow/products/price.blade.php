@extends('layouts.app')
{{-- page header --}}
@section('title','Product Price | Sales Flow')
	...
	<div class="row">
		...
		<div class="col-md-9">
			@if($product->same_price != 'No')
				{!! Form::model($defaultPrice,['route' =>['salesflow.product.price.update',$defaultPrice->id],'method'=>'post','enctype'=>'multipart/form-data','data-parsley-validate' => '']) !!}
									...
									<table class="table table-striped">
										...
										<tbody>
											@foreach ($prices as $price)
												{!! Form::model($price,['route' =>['salesflow.product.price.update',$price->id],'method'=>'post']) !!}
