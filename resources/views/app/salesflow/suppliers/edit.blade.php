@extends('layouts.app')
{{-- page header --}}
@section('title','Edit supplier | Finance')
...
@section('content')
	<div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><a href="{!! route('finance.supplier.index') !!}">Suppliers</a></li>
      ...
      {!! Form::model($supplier, ['route' => ['finance.supplier.update',$supplier->supplierCode], 'method'=>'post','enctype'=>'multipart/form-data']) !!}
         {!! csrf_field() !!}
         <div class="row">
            <div class="col-md-6">
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div class="form-group form-group-default required">
                        ...
                        {{ Form::select('contact_type',[''=>'Choose Supplier Type','Individual'=>'Individual','Organization'=>'Company/Organization'], null, ['class' => 'form-control select2','id' => 'contact_type' ]) }}
                     </div>
                     <div class="form-group form-group-default">
                        {!! Form::label('supplier_name', 'Suppliers Name', array('class'=>'control-label')) !!}
                        {!! Form::text('supplier_name', null, array('class' => 'form-control', 'placeholder' => 'Supplier Names')) !!}
                     </div>
                     @if ($supplier->contact_type == "Individual")
                        <div class="row">
                           <div class="col-sm-4">
                              <div class="form-group form-group-default">
                     ...
                     <div class="row ">
                        <div class="col-md-6">
                           {{-- <div class="form-group form-group-default">
                              ...
                              {{ Form::select('payment_terms', $terms, null, ['class' => 'form-control full-width', 'required' => '' ]) }}
                           </div> --}}
                           {{-- <div class="checkbox ">
                           ...
                           {{-- <div class="form-group form-group-default required">
                              ...
                              {{ Form::select('language', $language, null, ['class' => 'form-control full-width', 'required' => '' ]) }}
                           </div> --}}
                           <div class="row">
                              <div class="col-sm-6">
                                 <div class="form-group form-group-default">
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="row">
                              <center><img src="{!! asset('businesses/'.Wingu::business()->business_code.'/suppliers/'.$supplier->supplierCode.'/images/'.$supplier->image) !!}" alt="" style="width:60%"></center>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row"><br>
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              {!! Form::textarea('remarks',null,['class'=>'form-control tinymcy', 'rows' => 5, 'placeholder'=>'content']) !!}
                           </div>
                           <br>
                        </div>
                     </div>
...
@section('scripts')
	<script>
      ...
      $(".select2").select2().val({!! json_encode($jointCategory) !!}).trigger('change');
   </script>
@endsection
