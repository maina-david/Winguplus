@extends('layouts.app')
{{-- page header --}}
@section('title','Brand Update | Point Of Sale')
      ...
      <div class="row">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     <table id="data-table-default" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           @foreach($brands as $count=>$br)
                              <tr>
                                 <td>{!! $count+1 !!}</td>
                                 <td>{!! $br->name !!}</td>
                                 {{-- <td>{!! Finance::products_by_brand_count($br->id) !!}</td> --}}
                                 <td>
                                    <a href="{{ route('pos.product.brand.edit', $br->brand_code) }}" class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>
                                    <a href="{!! route('pos.product.brand.destroy', $br->brand_code) !!}" class="btn btn-danger btn-sm delete"><i class="fas fa-trash"></i></a>
                                 </td>
                              </tr>
                           @endforeach
                        </tbody>
         ...
         <div class="col-md-6">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     {!! Form::model($brand, ['route' => ['pos.product.brand.update',$brand->brand_code], 'method'=>'post','enctype'=>'multipart/form-data','data-parsley-validate' => '']) !!}
                        @csrf
