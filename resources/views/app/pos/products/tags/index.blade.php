@extends('layouts.app')
{{-- page header --}}
@section('title','Product Tags | Point Of Sale')
{{-- page styles --}}
      ...
      <div class="row">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     <table id="data-table-default" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           @foreach($tags as $count=>$all)
                              <tr>
                                 <td>{!! $count+1 !!}</td>
                                 <td>{!! $all->name !!}</td>
                                 {{-- <td>{!! Finance::products_by_tags_count($all->id) !!}</td> --}}
                                 <td>
                                    <a href="{{ route('pos.product.tags.edit', $all->id) }}" class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>
                                    <a href="{!! route('pos.product.tags.destroy', $all->id) !!}" class="btn btn-danger btn-sm delete"><i class="fas fa-trash"></i></a>
                                 </td>
                              </tr>
                           @endforeach
                        </tbody>
         ...
         <div class="col-md-6">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     {!! Form::open(array('route' => 'pos.product.tags.store')) !!}
                        @csrf
