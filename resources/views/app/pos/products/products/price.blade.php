@extends('layouts.app')
{{-- page header --}}
@section('title','Price | Point of Sale')
...
<div id="content" class="content">
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header"><i class="fal fa-usd-circle"></i> Price | {!! $product->product_name !!}</h1>
	<!-- end page-header -->
	...
	<div class="row">
		...
		<div class="col-md-9">
         @if($product->same_price != 'No')
            {!! Form::model($defaultPrice,['route' =>['pos.products.price.update',$productCode],'method'=>'post','enctype'=>'multipart/form-data','data-parsley-validate' => '']) !!}
					<div class="panel panel-default">
						...
						<div class="panel-body">
                           ...
                           <input type="hidden" name="price_id" value="{!! $defaultPrice->id !!}">
								</div>
						...
						<div class="col-md-12 mt-3">
							<div class="row">
								<div class="col-md-12">
                                    ...
                                    {!! Form::model($price,['route' =>['pos.products.price.update',$productCode],'method'=>'post']) !!}
