@extends('layouts.app')
{{-- page header --}}
@section('title','Edit supplier | Point Of Sale')
...
@section('content')
	<div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><a href="{!! route('pos.supplier.index') !!}">Suppliers</a></li>
      ...
      {!! Form::model($supplier, ['route' => ['pos.supplier.update',$supplier->supplier_code], 'method'=>'post','enctype'=>'multipart/form-data']) !!}
         {!! csrf_field() !!}
         <div class="row">
            <div class="col-md-6">
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div class="form-group form-group-default">
                        {!! Form::label('supplier_name', 'Suppliers Name', array('class'=>'control-label text-danger')) !!}
                     ...
                     <div class="row ">
                        <div class="col-md-6">
                           ...
                           <div class="form-group form-group-default">
										...
										{{ Form::select('category[]', $category, null, ['class' => 'form-control multiple-select2','multiple' => 'multiple']) }}
									</div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                           ...
                           <div class="row">
                              <center>
                                 <img src="{!! asset('businesses/'.Wingu::business()->business_code.'/suppliers/'.$supplier->supplier_code.'/images/'.$supplier->image) !!}" alt="" style="width:60%">
                              </center>
                           </div>
                        </div>
                     </div>
...
@section('scripts')
	<script>
      ...
      $(".multiple-select2").select2();
		$(".multiple-select2").select2().val({!! json_encode($connectedCategory) !!}).trigger('change');
   </script>
@endsection
