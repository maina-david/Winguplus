...
<div class="content">
	...
	<ol class="breadcrumb pull-right">
		...
		<li class="breadcrumb-item"><a href="{!! route('pos.supplier.index') !!}">Supplier</a></li>
	...
	{!! Form::open(array('route' => 'pos.supplier.store','enctype'=>'multipart/form-data','data-parsley-validate' => '', 'method'=>'post' )) !!}
		{!! csrf_field() !!}
		<div class="row">
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group form-group-default required">
							{!! Form::label('Supplier', 'Supplier Name', array('class'=>'control-label text-danger')) !!}
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group form-group-default">
									...
									{{ Form::select('category[]', $groups, null, ['class' => 'form-control select2','multiple' => 'multiple']) }}
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group form-group-default">
