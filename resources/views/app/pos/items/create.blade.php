   ...
   <div id="content" class="content">
      ...
      @include('partials._messages')
		<div class="row">
         ...
         <div class="col-md-9">
            <!-- end of shop menu -->
            {!! Form::open(array('route' => 'finance.products.store', 'enctype'=>'multipart/form-data','method' => 'post','autocomplete' => 'off')) !!}
            {!! csrf_field() !!}
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group form-group-default required ">
                           ...
                           {{ Form::select('type',[''=>'Choose type','product'=>'Standard Product','variants'=>'Product with variant'], null, ['class' => 'form-control multiselect', 'required' => '', 'id' => 'type']) }}
                        </div>
                     </div>
                     {{-- ,'variants'=>'Product with variants' --}}
                     <div class="col-md-6" style="display:none;" id="variants-entries">
                        <div class="form-group form-group-default required ">
                           {!! Form::label('title', 'Variant Attribute', array('class'=>'control-label')) !!}
                     ...
                     {{-- <div class="col-md-6">
                        <div class="form-group form-group-default required ">
                           ...
                           {{ Form::select('status',[''=>'Choose status','No'=>'No','Yes'=>'Yes'], null, ['class' => 'form-control multiselect', 'required' => '']) }}
                        </div>
                     </div> --}}
                     <div class="col-md-6">
                        <div class="form-group form-group-default required">
                        ...
                        <div class="row" id="products">
                           ...
                           {{-- <div class="col-md-6">
                              <div class="form-group form-group-default required ">
                                 ...
                                 {{ Form::select('ecommerce_item',[''=>'Choose option','No'=>'No','Yes'=>'Yes'], null, ['class' => 'form-control multiselect']) }}
                              </div>
                           </div> --}}
                        </div>
                     </div>
               ...
               <div class="panel-body">
                  <div class="col-md-12">
                     <div class="form-group form-group-default">
                        ...
                        {{ Form::select('category[]',$categories,null,['class' => 'form-control multiselect', 'multiple' => 'multiple']) }}
                     </div>
                     <div class="form-group form-group-default">
