      ...
      <div class="row">
                           ...
                           <tbody>
                              @foreach($attributes as $attribute)
                                 <tr>
                                    ...
                                    <td>{!! Finance::products_by_brand_count($attribute->id) !!}</td>
                                    <td>
            ...
            <div class="col-md-6">
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div class="panel-body">
                        {!! Form::model($edit, ['route' => ['finance.product.attributes.update',$edit->id], 'method'=>'post','enctype'=>'multipart/form-data']) !!}
                           @csrf
