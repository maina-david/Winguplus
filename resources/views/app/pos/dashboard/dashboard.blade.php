		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-blue">
				...
				<div class="stats-content">
					...
					<div class="stats-number">{!! $business->currency !!}{!! number_format($todaySales) !!}</div>
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-black">
				...
				<div class="stats-content">
					...
					<div class="stats-number">{!! $business->currency !!}{!! number_format($monthSales) !!}</div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width:100%;"></div>
					</div>
					<div class="stats-desc"><a href="{!! route('sales.history') !!}" class="text-white">view sales</a></div>
		...
		<div class="col-xl-3 col-md-6">
			<div class="widget widget-stats bg-green">
				...
				<div class="stats-content">
					...
					<div class="stats-number">{!! $business->currency !!}{!! number_format($averageSale) !!}</div>
					<div class="stats-progress progress">
						<div class="progress-bar" style="width:100%;"></div>
					</div>
					<div class="stats-desc"><a href="{!! route('sales.history') !!}" class="text-white">view sales</a></div>
