         ...
         <tbody>
            @foreach ($creditnotes as $crt => $v)
               <tr role="row" class="odd">
                  <td>{{ $crt+1 }}</td>
                  <td>
                     <b>{!! Finance::creditnote()->prefix !!}00{!! $v->creditnote_number !!}</b>
                  </td>
                  ...
                  <td>
                     <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                           <li><a href="{{ route('finance.creditnote.show', $v->id) }}"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;&nbsp; View</a></li>
                           <li><a href="{!! route('finance.creditnote.edit', $v->id) !!}"><i class="fas fa-edit"></i>&nbsp;&nbsp; Edit</a></li>
                           <li><a href="{!! route('finance.creditnote.delete', $v->id) !!}"><i class="fas fa-trash-alt"></i>&nbsp;&nbsp; Delete</a></li>
                        </ul>
                     </div>
                  </td>
               </tr>
