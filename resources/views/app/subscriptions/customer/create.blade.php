...
<div class="content">
	...
	{!! Form::open(array('route' => 'subscription.customer.store','enctype'=>'multipart/form-data','method'=>'post' )) !!}
	{!! csrf_field() !!}
	<div class="row">
		<div class="col-md-6">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group form-group-default required ">
						...
						{!! Form::email('email', null, array('class' => 'form-control', 'placeholder' => 'Enter customer email', 'required' =>'' )) !!}
					</div>
					<div class="form-group form-group-default ">
