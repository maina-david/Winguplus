...
<div class="content">
	...
	{!! Form::open(array('route' => 'assets.store','enctype'=>'multipart/form-data', 'class'=>'row', 'method'=>'post' )) !!}
		@csrf
      <div class="col-md-12">
         ...
         <div class="tab-content panel rounded-0">
            ...
            {{-- <div class="tab-pane fade" id="allotted">
               <div class="row">
                  <div class="col-md-8">
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              {!! Form::label('Allotted', 'Allotted Date', array('class'=>'control-label')) !!}
                              {!! Form::date('allocation_date', null, array('class' => 'form-control')) !!}
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              {!! Form::label('Allotted', 'Allotted Upto', array('class'=>'control-label')) !!}
                              {!! Form::date('allotted_upto', null, array('class' => 'form-control')) !!}
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="form-group">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              ...
                              {{ Form::select('vehicle_model',[], null, ['class' => 'form-control select2', 'id'=>'model']) }}
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
