<div class="row">
   <div class="col-md-8">
      {!! Form::model($edit, ['route' => ['licenses.maintenances.update',[$details->asset_code,$edit->maintenance_code]], 'method'=>'post','enctype' => 'multipart/form-data','autocomplete' => 'off']) !!}
         @csrf
         <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
               <div class="form-group form-group-default">
                  ...
                  {!! Form::date('completion_date',null,['class'=>'form-control','placeholder' => 'Enter date']) !!}
               </div>
            </div>
            <div class="col-md-6">
               <div class="form-group form-group-default">
