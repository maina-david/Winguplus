<div class="row">
   <form method="post" action="{!! route('licenses.maintenances.store',$details->asset_code) !!}" autocomplete="off" class="col-md-8">
      @csrf
      <div class="row">
         <div class="col-md-6">
         ...
         <div class="col-md-6">
            <div class="form-group form-group-default required">
               ...
               {!! Form::date('start_date',null,['class'=>'form-control' ,'placeholder' => 'Choose date', 'required' => '']) !!}
            </div>
         </div>
         <div class="col-md-6">
            <div class="form-group form-group-default">
               <label for="">Completion Date</label>
               {!! Form::date('completion_date',null,['class'=>'form-control','placeholder' => 'Choose date']) !!}
            </div>
         </div>
         <div class="col-md-6">
            <div class="form-group form-group-default">
