@extends('layouts.app')
{{-- page header --}}
@section('title','Digital Marketing Channels')
{{-- page styles --}}
@section('stylesheet')
      ...
      <div class="row">
         ...
         <div class="col-md-5">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  {!! Form::model($edit, ['route' => ['crm.channel.update',$edit->id], 'method'=>'post','class' => '']) !!}
                     @csrf
                     <input type="hidden" name="accountID" value="{!! $accountID !!}" required>  
                     <div class="form-group form-group-default">
                        <label for="">Medium</label>
                        {!! Form::select('mediumID',$mediums,null,['class'=>'form-control multiselect']) !!}
                     </div>
                     <div class="form-group form-group-default">
