@extends('layouts.app')
@section('title','Management Dashboard | Customer relationship management')
@section('stylesheet')
@endsection
@section('sidebar')
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="card" style="height: 550px">
               ...
               <div class="card-body">
                  <img src="{!! asset('assets/img/salestrendfuture.gif') !!}" alt="" class="img-responsive" height="470px">
               </div>
            </div>
         </div>
         <div class="col-md-8">
            <div class="card" style="height: 550px">
               ...
               <div class="card-body">
                  <img src="{!! asset('assets/img/salestrend_anomalies.gif') !!}" alt="" class="img-responsive" height="470px">
               </div>
            </div>
         </div>
         <div class="col-md-4">
         ...
         <div class="col-md-4">
            <div class="card" style="height: 550px">
               ...
               <div class="card-body">
                  <img src="{!! asset('assets/img/filter.png') !!}" alt="" class="img-responsive">
               </div>
            </div>
         </div>
         <div class="col-md-4">
