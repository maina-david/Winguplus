@extends('layouts.app')
@section('title','CRM | Reports | Industry')
@section('stylesheet')
@endsection
@section('sidebar')
...
@section('content')
   ...
   <div id="content" class="content">
      ...
      <!-- begin page-header -->
      <h1 class="page-header"><i class="fal fa-industry-alt"></i> Leads by industry | {!! $industryRequest !!} | {!!  date('F j, Y', strtotime($start)) !!} to {!!  date('F j, Y', strtotime($end)) !!}</h1>
      @include('partials._messages')
      <div class="row">
         <div class="col-md-8">
            <form action="{!! route('crm.reports.leads.industry.filter') !!}" method="GET" class="row" autocomplete="off">
               <div class="col-md-3">
                  <div class="form-group">
                     {!! Form::select('industry',$industies,null,['class'=>'form-control multiselect']) !!}
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="form-group">
         ...
         <div class="col-md-4">
            <a href="{!! route('crm.reports.leads.industry.export',[$industryValue,$start,$end]) !!}" class="float-right btn btn-pink"><i class="fal fa-file-excel"></i> Export to csv</a>
         </div>
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
