 ...
 @foreach ($notes as $note)
   <div class="card">
      ...
      <div class="card-footer text-muted">
         <div class="row">
            ...
            <div class="col-md-4">
               <a href="{!! route('crm.customer.notes.delete', $note->note_code) !!}" class="btn btn-sm btn-danger float-right delete"><i class="fas fa-trash"></i> Delete</a>
               <a href="#" data-toggle="modal" data-target="#edit-note-{!! $note->note_code !!}" class="btn btn-sm float-right mr-2 btn-primary"><i class="fas fa-edit"></i> Edit</i></a>
            </div>
         </div>
      </div>
   </div>
   <div class="modal fade" id="edit-note-{!! $note->note_code !!}">
      <div class="modal-dialog modal-lg">
         {!! Form::model($note, ['route' => ['finance.customer.notes.update', $note->note_code], 'method'=>'post']) !!}
            @csrf
...
<div class="modal fade" id="add-note">
   <div class="modal-dialog modal-lg">
      <form action="{!! route('crm.customer.notes.store') !!}" method="post">
         @csrf
         <div class="modal-content">
            <div class="modal-header">
