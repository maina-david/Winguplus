            ...
            @foreach ($invoices as $crt => $v)
               <tr role="row" class="odd">
                  ...
                  <td class="v-align-middle">
                     ...
                     @else
                     <b>{!! $client->currency !!} {{ number_format(round($v->total - $v->paid)) }}</b>
                     @endif
                  </td>
                  ...
                  @endif
                  <td>
                     <a href="{{ route('finance.invoice.show', $v->invoice_code) }}" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> view</a>
                  </td>
               </tr>
            @endforeach
         </tbody>
