         ...
         <div class="modal-body">
            ...
            <div class="row">
               <div class="col-sm-6">
						<div class="form-group form-group-default required">
							{!! Form::label('names', 'Start Date', array('class'=>'control-label text-danger')) !!}
							{!! Form::date('start_date', null, array('class' => 'form-control', 'placeholder' => 'YYYY-MM-DD' , 'required' => '')) !!}
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group form-group-default required">
            ...
            <div class="row">
               <div class="col-sm-6">
						<div class="form-group form-group-default">
							{!! Form::label('names', 'End Date', array('class'=>'control-label')) !!}
							{!! Form::date('end_date', null, array('class' => 'form-control', 'placeholder' => 'YYYY-MM-DD')) !!}
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group form-group-default">
