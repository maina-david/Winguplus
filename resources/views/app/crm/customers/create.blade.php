...
<div class="content">
	...
	{!! Form::open(array('route' => 'crm.customers.store','enctype'=>'multipart/form-data','data-parsley-validate' => '', 'method'=>'post' )) !!}
	{!! csrf_field() !!}
	<div class="row">
		<div class="col-md-6">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group form-group-default required">
						{!! Form::label('Customer Type', 'Customer Type', array('class'=>'control-label text-danger')) !!}
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group form-group-default">
								...
								{{ Form::select('groups[]', $groups, null, ['class' => 'form-control select2','multiple' => 'multiple']) }}
							</div>
							{{-- <div class="form-group form-group-default">
