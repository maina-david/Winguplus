      ...
      <div class="widget-chat widget-chat-rounded">
         ...
         <div class="widget-chat-header">
            <div class="widget-chat-header-icon">
               ...
               @else
               <img src="{!! asset('businesses/'.Wingu::business()->business_code.'/customer/'.$code.'/'.$client->image) !!}" alt="" style="width:40px;height:40px" class="rounded-circle">
               @endif
            </div>
         ...
         <div class="widget-input widget-input-rounded">
            <form action="{!! route('crm.customer.sms.send') !!}" method="POST" class="row">
               @csrf
               <div class="col-md-12">
                  ...
                  <div class="form-group">
                     ...
                     <input type="hidden" name="customerID" value="{!! $code !!}" readonly>
                  </div>
                  <div class="row">
                     <div class="col-md-12">
