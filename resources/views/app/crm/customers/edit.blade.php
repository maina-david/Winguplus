@extends('layouts.app')
{{-- page header --}}
@section('title','Edit Customer | Customers Relationship Management')
...
@section('content')
	<div id="content" class="content">
      ...
      {!! Form::model($contact, ['route' => ['crm.customers.update',$contact->customer_code], 'method'=>'post','enctype'=>'multipart/form-data']) !!}
         {!! csrf_field() !!}
         <div class="row">
            <div class="col-md-6">
							...
							<div class="row ">
								<div class="col-md-6">
									<div class="form-group form-group-default">
										...
										{{ Form::select('groups[]', $category, null, ['class' => 'form-control multiple-select2','multiple' => 'multiple']) }}
									</div>
									{{-- <div class="form-group form-group-default">
								...
								<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-12">
											<center>
												<img src="{!! asset('businesses/'.Wingu::business()->business_code.'/customer/'.$contact->customer_code.'/'.$contact->image) !!}" alt="" style="width:30%">
											</center>
										</div>
									</div>
								</div>
...
@section('scripts')
	<script>
      ...
      $("#set-post-thumbnail").click(function() {
		...
		$(".multiple-select2").select2().val({!! json_encode($selectedCategory) !!}).trigger('change');
	</script>
@endsection
