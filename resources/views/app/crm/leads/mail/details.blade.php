                     ...
                     <div class="email-head">
                        ...
                        <div class="email-head-sender d-flex align-items-center justify-content-between flex-wrap">
                           <div class="d-flex align-items-center">
                              <div class="avatar">
                                 @if($lead->image != "")
                                    <img class="rounded-circle user-avatar-md" alt="" class="{!! $lead->names !!}" src="{!! asset('businesses/'.$lead->business_code.'/clients/'.$lead->customer_code.'/images/'.$lead->image) !!}" style="width:50px;height:50px">
                                 @else
                                    <img src="https://ui-avatars.com/api/?name={!! $lead->customer_name !!}&rounded=true&size=50 alt="" class="rounded-circle user-avatar-md">
                                 @endif
                              </div>
                           ...
                           <div class="date">{!! date('F d, Y @ h:i:s A', strtotime($mail->created_at)) !!}</div>
                        </div>
                     </div>
