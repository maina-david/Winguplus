                           ...
                           <li class="list-group-item">
                              <div class="media">
                                 <div class="pull-left">
                                    <div class="thumb">
                                       @if($lead->image != "")
                                          <img class="rounded-circle" alt="" class="{!! $lead->names !!}" src="{!! asset('businesses/'.$lead->primary_email.'/clients/'.$lead->customer_code.'/images/'.$lead->image) !!}" style="width:50px;height:50px">
                                       @else
                                          <img src="https://ui-avatars.com/api/?name={!! $lead->customer_name !!}&rounded=true&size=50 alt="">
                                       @endif
                                    </div>
                                 </div>
                                 <div class="media-body">
                                    <div class="media-heading">
                                       <a href="{!! route('crm.leads.details',[$mail->mail_code,$code]) !!}" class="m-r-10">{!! $mail->names !!}</a>
                                       @if($mail->status == "Sent")
                                       ...
                                       <small class="float-right text-muted">
                                          <time class="hidden-sm-down" datetime="2017">{!! date('F d, Y @ h:i:s A', strtotime($mail->created_at)) !!}</time>
