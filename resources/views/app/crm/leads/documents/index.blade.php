   ...
   @foreach ($documents as $document)
            ...
            <div class="widget-list-item">
               ...
               <div class="widget-list-action">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     <li><a href="{!! asset('businesses/'.Wingu::business(Auth::user()->business_code)->business_code.'/customer/'.$lead->reference_number.'/'.$document->file_name) !!}" target="_blank">View document</a></li>
                     <li><a href="{!! route('crm.leads.documents.delete',[$document->id,$code]) !!}" class="delete">Delete</a></li>
                  </ul>
               </div>
            </div>
      ...
      <div class="modal fade" id="update-document-{!! $document->id !!}" tabindex="-1" role="dialog">
         <div class="modal-dialog modal-lg">
            {!! Form::model($document, ['route' => ['crm.leads.documents.update', $document->id], 'method'=>'post', 'autocomplete'=>'off','enctype' => 'multipart/form-data']) !!}
...
<div class="modal fade" id="add-document" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-lg">
      {!! Form::open(array('route' => 'crm.leads.documents.store','method' =>'post','autocomplete'=>'off','enctype' => 'multipart/form-data')) !!}
         <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title"> Add Document</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
