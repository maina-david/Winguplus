@extends('layouts.app')
{{-- page header --}}
@section('title','Leads | Canvas | Customer Relationship Management')
      ...
      <div class="float-right">
         <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
               <li><a href="{!! route('crm.leads.index') !!}"><i class="fal fa-list"></i> List view</a></li>
            </ul>
         </div>
