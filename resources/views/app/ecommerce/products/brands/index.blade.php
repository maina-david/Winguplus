...
@section('content')
   <div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><a href="{!! route('finance.product.brand') !!}">Product Brands</a></li>
      ...
      <div class="row">
                           ...
                           @foreach($brands as $all)
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <a href="{{ route('finance.product.brand.edit', $all->id) }}" class="btn btn-primary"><i class="far fa-edit"></i></a>
                                    @endpermission
                                    @permission('delete-productbrand')
                                    <a href="{!! route('finance.product.brand.destroy', $all->id) !!}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                    @endpermission
                                 </td>
                              </tr>
                           @endforeach
         ...
         <div class="col-md-6">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     {!! Form::open(array('route' => 'finance.product.brand.store')) !!}
                        @csrf
