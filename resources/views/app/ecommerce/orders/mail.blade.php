...
@section('content')
   <div id="content" class="content">
      ...
      <div class="pull-right">
         <a href="{!! route('finance.invoice.show',$invoice->invoiceID) !!}" class="btn btn-pink"><i class="fas fa-chevron-left"></i> Back to view</a>
      </div>
      <!-- end breadcrumb -->
      <!-- begin page-header -->
                     ...
                     <div class="form-group col-md-12">
                        ...
                        <select name="email_cc[]" id="" class="form-control multiselect" style="width:100%" multiple>
   						...
   						<div class="form-group col-md-12">
   							...
   							<input type="text" name="subject" value="Invoice - {!! $invoice->prefix !!}{!! $invoice->invoice_number !!} from {!! $invoice->businessName !!}" class="form-control" required>
   						</div>
   						<div class="form-group col-md-12">
                           ...
                           <span style="font-size: 12pt;">
                              We have prepared the following invoice for you: <strong># {!! $invoice->prefix !!}{!! $invoice->invoice_number !!}</strong>
                           </span>
                           <br /><br />
                           <span style="font-size: 12pt;">
                              <strong>Invoice status</strong>:<i>{!! ucfirst($invoice->name) !!}</i>
                           </span><br />
                           ...
                           <span style="font-size: 12pt;">{!! $invoice->businessName !!}</span>
   							</textarea>
   						</div>
   						<div class="form-group mt-3">
                        <input type="checkbox" value="Yes" name="attaches" id="attach" class="ml-2" checked>
                        <label for="">Attach Invoice</label><br>
                        <a href="{!! asset('businesses/'.$invoice->business_code.'/finance/invoices/'.$invoice->prefix.$invoice->invoice_number.'.pdf') !!}" target="_blank" class="ml-3" id="preview"> Preview current Attached Invoice</a>
   						</div>
   						<div class="form-group col-md-12">
