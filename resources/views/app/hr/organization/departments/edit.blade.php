@extends('layouts.app')
{{-- page header --}}
@section('title','Edit Department | Human Resource')
@section('sidebar')
...
@section('content')
	<div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item active"><a href="{!! route('hrm.departments') !!}">Edit</a></li>
      </ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
      ...
      <!-- begin widget-list -->
      <div class="row">
         {!! Form::model($edit, ['route' => ['hrm.departments.update',$edit->department_code], 'method'=>'post','class' => 'col-md-12']) !!}
            @csrf
            <div class="card">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        <div class="form-group form-group-default">
                           ...
                           {!! Form::select('parent_code', $departments, null, array('class' => 'form-control multiselect')) !!}
                        </div>
                     </div>
                     <div class="col-md-3">
                        <div class="form-group form-group-default">
