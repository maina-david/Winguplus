@extends('layouts.app')
@section('title','Edit Assigned Leave ')
@section('sidebar')
...
@section('content')
   <div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><a href="{!! route('hrm.leave.index') !!}">Leave</a></li>
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="card">
               ...
               <div class="card-body">
                  {!! Form::model($edit, ['route' => ['hrm.leave.update',$edit->leave_code], 'method'=>'post','enctype'=>'multipart/form-data', 'autocomplete' => 'off']) !!}
                     @csrf
