@extends('layouts.app')
@section('title','Leave application | Human Resource')
@section('sidebar')
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="card">
               ...
               <div class="card-body">
                  <form action="{!! route('hrm.leave.apply.store') !!}" method="post" autocomplete="off">
                     @csrf
                     <div class="form-group form-group-default required">
                        <label for="" class="text-danger">Leave Type</label>
                        {!! Form::select('type_code', $types, null, array('class' => 'form-control select2', 'required' => '','id' => 'type')) !!}
                     </div>
                     <div class="row">
      						<div class="col-sm-6">
      							<div class="form-group form-group-default required">
      								{!! Form::label('names', 'Start', array('class'=>'control-label text-danger')) !!}
      								{!! Form::date('start_date', null, array('class' => 'form-control', 'placeholder' => 'Choose date', 'required' => '')) !!}
      							</div>
      						</div>
      						<div class="col-sm-6">
      							<div class="form-group form-group-default">
      								{!! Form::label('Time', 'End', array('class'=>'control-label text-danger')) !!}
