@extends('layouts.app')
{{-- page header --}}
@section('title') Add Property | Property Wingu @endsection
{{-- page styles --}}
@section('stylesheet')
   <style>
      .map_canvas {
   ...
   <div id="content" class="content">
      ...
      <div class="row">
         <div class="col-md-12">
            ...
            {!! Form::open(array('route' => 'propertywingu.property.store','enctype'=>'multipart/form-data','method'=>'post','autocomplete' => '')) !!}
               {!! csrf_field() !!}
                           ...
                           <div class="form-group form-group-default">
                              ...
                              <select name="landlord" class="form-control select2">
                                 ...
                                 @foreach ($landlords as $landlord)
                                    <option value="{!! $landlord->customerID !!}">{!! $landlord->customer_name !!}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
