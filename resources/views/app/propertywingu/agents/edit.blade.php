...
<div id="content" class="content">
   ...
   <ol class="breadcrumb pull-right">
      ...
      <li class="breadcrumb-item"><a href="{!! route('property.agents') !!}">{!! $edit->names !!}</a></li>
   ...
   <div class="card card-default">
      <div class="card-body">
         ...
         {!! Form::model($edit, ['route' => ['property.agents.update',$edit->agentID], 'class' =>'row','method'=>'post','enctype'=>'multipart/form-data']) !!}
            @csrf
            <div class="col-sm-6">
