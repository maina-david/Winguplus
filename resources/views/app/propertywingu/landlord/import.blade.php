	...
	<div id="content" class="content">
      <div class="row">
         <div class="col-md-12  mb-2">
            <a href="{!! url('/') !!}/public/samples/landlord_import_sample_file.csv" class="btn btn-danger pull-right"><i class="fal fa-file-download"></i> Download Sample</a>
         </div>         
         <div class="col-md-12">
         ...
         <div class="panel-body">
            <div class="row">
               <div class="col-md-4 mtop15">
                  <form action="{!! route('landlord.import') !!}" id="import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                     @csrf
