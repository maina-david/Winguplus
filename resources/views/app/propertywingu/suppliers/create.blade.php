...
<div id="content" class="content">
   ...
   <!-- end breadcrumb -->
	<div class="row"> 
      ...
      {!! Form::open(array('route' => 'property.supplier.store','enctype'=>'multipart/form-data','class' => 'col-md-12', 'method'=>'post' )) !!}
         {!! csrf_field() !!}
         <div class="row">
            <div class="col-md-6">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           ...
                           <div class="form-group form-group-default">
                              ...
                              {{ Form::select('categories[]', $groups, null, ['class' => 'form-control multiselect','multiple' => 'multiple']) }}
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
