            ...
            <div class="col-md-12"> 
               <div class="row mb-3">
                  <span class="col-md-12">
                     ...
                     @endpermission
                     <a href="{!! route('property.utility.compose.mail',[$propertyID,$invoice->invoiceID]) !!}" class="btn btn-sm btn-warning m-b-10 p-l-5">
               ...
               <div class="panel"> 
                  <div class="panel-body">         
                     @include('templates.'.$business->template_name.'.utility.preview')
                  </div>
               </div>
            </div>
            {{-- Invoice payment --}}
            <form action="{!! route('property.utility.payment',[$propertyID,$invoiceID]) !!}" method="post" enctype="multipart/form-data" autocomplete="off">
               @csrf
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group form-group-default required">
                                    ...
                                    <input type="text" value="{!! $invoice->invoice_balance !!}" name="amount" class="form-control" placeholder="Enter amount" required>
