   ...
   <h1 class="page-header"><i class="fal fa-users-medical"></i> Tenants | Edit </h1>
	<div class="row">  
      <div class="col-md-12">
         ...
         {!! Form::model($tenant, ['route' => ['tenants.update',$tenant->tenantID],'enctype'=>'multipart/form-data','method'=>'post','autocomplete' => '']) !!}
            {!! csrf_field() !!}
            <div class="row"> 
               <div class="col-md-6"> 
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        <div class="form-group form-group-default">
                           {!! Form::label('Client Type', 'Tenant Type', array('class'=>'control-label text-danger')) !!}
                           {{ Form::select('tenant_type',[''=>'Choose Tenant Type','Individual'=>'Individual','Organization'=>'Company/Organization'], null, ['class' => 'form-control', 'id' => 'tenantType', 'required' => '']) }}
                        </div>
                        <div class="form-group form-group-default">
                           {!! Form::label('tenant_name', 'Tenant Name', array('class'=>'control-label text-danger')) !!}
                           {!! Form::text('tenant_name', null, array('class' => 'form-control', 'placeholder' => 'Tenant Names', 'required' => '')) !!}
                        </div>
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">                        
                        ...
                        <div class="row">
                           <div class="col-sm-6">
                              <div class="form-group form-group-default">
                                 {!! Form::label('primary_phone_number', 'Phone Number', array('class'=>'control-label text-danger')) !!}
                                 {!! Form::text('phone_number', null, array('class' => 'form-control','placeholder' => 'e.x 0700 000 000','required' => '')) !!}
                              </div>
                           </div>
                           <div class="col-sm-6">
                              <div class="form-group form-group-default">
                     ...
                     <div class="tab-pane active" id="other_details">
                        <div class="row ">
                           ...
                           <div class="col-md-6">
                              ...
                              @if($tenant->image != "")
                                 <img alt="" class="img-circle" src="{!! asset('businesses/'.Wingu::business(Auth::user()->businessID)->businessID .'/property/tenant/'. $tenant->tenant_code .'/images/'.$tenant->image) !!}" style="width:50%">
                              @endif
                           </div>
                        </div>
                     </div>
