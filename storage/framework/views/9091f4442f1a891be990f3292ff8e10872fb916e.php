   ...
   <div id="content" class="content">
      ...
      <?php echo $__env->make('partials._messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<div class="row">
         ...
         <div class="col-md-9">
            <!-- end of shop menu -->
            <?php echo Form::open(array('route' => 'pos.products.store', 'enctype'=>'multipart/form-data','method' => 'post','autocomplete' => 'off')); ?>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group form-group-default required ">
                           ...
                           <?php echo e(Form::select('type',['product'=>'Standard Product'], null, ['class' => 'form-control select2', 'required' => '', 'id' => 'type'])); ?>

                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group form-group-default">
                           <?php echo Form::label('title', 'Is Item Active', array('class'=>'control-label')); ?>
                     ...
                     <div class="col-md-6">
                        <div class="form-group form-group-default">
                           ...
                           <?php echo e(Form::select('code_type',['Auto'=>'Automatically Generate a SKU','Custom'=>'Enter a custom SKU'], null, ['class' => 'form-control select2', 'required' => '', 'id' => 'sku'])); ?>
               ...
               <div class="panel-body">
                  <div class="col-md-12">
                     <div class="form-group form-group-default">
                        ...
                        <?php echo e(Form::select('category[]',$categories,null,['class' => 'form-control select2', 'multiple' => 'multiple'])); ?>

                     </div>
                     <div class="form-group form-group-default">
                        <?php echo Form::label('title', 'Item Tags', array('class'=>'control-label')); ?>

                        <?php echo e(Form::select('tags[]',$tags,null,['class' => 'form-control select2', 'multiple' => 'multiple'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/pos/products/products/create.blade.php ENDPATH**/ ?>