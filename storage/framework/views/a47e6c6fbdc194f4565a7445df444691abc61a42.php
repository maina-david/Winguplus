<?php $__env->startSection('title','Edit Licenses | Asset Management'); ?>
...
<div class="content">
	...
	<?php echo Form::model($edit, ['route' => ['licenses.assets.update',$edit->asset_code], 'method'=>'post','enctype' => 'multipart/form-data', 'autocomplete' => 'off']); ?>
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="row">
                     ...
                     <?php if($edit->assigned_to == 'Employee'): ?>
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                     ...
                     <?php endif; ?>
                     <?php if($edit->assigned_to == 'Customer'): ?>
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/assets/licenses/edit.blade.php ENDPATH**/ ?>