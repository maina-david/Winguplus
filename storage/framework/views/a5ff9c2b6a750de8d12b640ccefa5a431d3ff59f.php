      ...
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-blue">
            ...
            <div class="stats-info">
               ...
               <p><?php echo $client->currency; ?><?php echo number_format($outstanding); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-red">
            ...
            <div class="stats-info">
               ...
               <p><?php echo $client->currency; ?><?php echo number_format($unusedCredits); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-green">
            ...
            <div class="stats-info">
               ...
               <p><?php echo $client->currency; ?><?php echo number_format($totalIncome); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/contacts/show.blade.php ENDPATH**/ ?>