<?php $__env->startSection('title','Edit supplier | Point Of Sale'); ?>
...
<?php $__env->startSection('content'); ?>
	<div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><a href="<?php echo route('pos.supplier.index'); ?>">Suppliers</a></li>
         <li class="breadcrumb-item active">Edit</li>
      </ol>
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header"><i class="fal fa-users-cog"></i> Update Supplier </h1>
      <?php echo $__env->make('partials._messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php echo Form::model($supplier, ['route' => ['pos.supplier.update',$supplier->supplier_code], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div class="form-group form-group-default">
                        <?php echo Form::label('supplier_name', 'Suppliers Name', array('class'=>'control-label text-danger')); ?>
                     ...
                     <div class="row ">
                        <div class="col-md-6">
                           ...
                           <div class="form-group form-group-default">
										...
										<?php echo e(Form::select('category[]', $category, null, ['class' => 'form-control multiple-select2','multiple' => 'multiple'])); ?>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="row">
                              <center>
                                 <img src="<?php echo asset('businesses/'.Wingu::business()->business_code.'/suppliers/'.$supplier->supplier_code.'/images/'.$supplier->image); ?>" alt="" style="width:60%">
                              </center>
                           </div>
                        </div>
                     </div>
...
<?php $__env->startSection('scripts'); ?>
	<script>
      ...
      $(".multiple-select2").select2();
		$(".multiple-select2").select2().val(<?php echo json_encode($connectedCategory); ?>).trigger('change');
   </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/pos/suppliers/edit.blade.php ENDPATH**/ ?>