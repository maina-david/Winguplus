<?php $__env->startSection('title','Create Quote | Finance'); ?>
         ...
         <div class="load-animate">
            ...
            <div class='row'>
               ...
               <div class="col-md-4 col-lg-4">
                  <div class="form-group form-group-default">
                     ...
                     <?php echo Form::select('tax_config',['Inclusive' => 'Tax Inclusive','Exclusive' => 'Tax Exclusive'],null,['class' => 'form-control select2', 'id' => 'taxconfig' ]); ?>
            ...
            <div class='row mt-3'>
               <div class="col-md-6 mt-3">
                  ...
                  <textarea name="customer_note" class="form-control tinymcy" rows="8" cols="80"><?php echo Finance::quote()->default_customer_notes; ?></textarea>
               </div>
               <div class="col-md-6 mt-3">
                  <label for="">Terms & Conditions</label>
                  <textarea name="terms" class="form-control tinymcy" rows="8" cols="80"><?php echo Finance::quote()->default_terms_conditions; ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/quotes/create.blade.php ENDPATH**/ ?>