...
<div class="content">
	...
	<?php echo Form::open(array('route' => 'finance.contact.store','enctype'=>'multipart/form-data','method'=>'post' )); ?>
						...
						<div class="col-md-6">
							<div class="panel-body">
								...
								<div class="form-group form-group-default">
									...
									<?php echo e(Form::select('ship_country', $country, null, ['class' => 'form-control select2'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/contacts/create.blade.php ENDPATH**/ ?>