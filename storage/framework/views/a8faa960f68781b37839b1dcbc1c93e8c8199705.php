<?php $__env->startSection('title','Sales by Item report'); ?>
...
<?php $__env->startSection('content'); ?>
	<div id="content" class="content">
      ...
      <div class="col-md-12 mb-3">
         <div class="row">
            ...
            <div class="col-md-4">
               <a href="<?php echo route('finance.report.sales.item.print',[$to,$from]); ?>" target="_blank" class="btn btn-pink pull-right"><i class="fas fa-file-pdf"></i> Export in pdf</a>
               <a href="<?php echo route('finance.report.sales.item.print',[$to,$from]); ?>" target="_blank" class="btn btn-pink pull-right mr-2"><i class="fas fa-print"></i> Print</a>
                  ...
                  <tbody>
                     <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           ...
                           <td><center><i><b><?php echo $product->currency; ?><?php echo number_format($product->total); ?></b></i></center></td>
                        </tr>
   ...
   <!-- Modal -->
   <form action="<?php echo route('finance.report.sales.item'); ?>" method="GET" autocomplete="off">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/reports/sales/item.blade.php ENDPATH**/ ?>