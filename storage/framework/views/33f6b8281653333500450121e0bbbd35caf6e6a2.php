<?php $__env->startSection('title','Edit Customer | Customers Relationship Management'); ?>
...
<?php $__env->startSection('content'); ?>
	<div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><a href="<?php echo route('crm.customers.index'); ?>">Customers</a></li>
         <li class="breadcrumb-item active">Edit</li>
      </ol>
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header"><i class="fal fa-user"></i> Edit Customer </h1>
      <?php echo $__env->make('partials._messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php echo Form::model($contact, ['route' => ['crm.customers.update',$contact->customer_code], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div class="form-group form-group-default required">
                        <?php echo Form::label('Client Type', 'Customer Type', array('class'=>'control-label text-danger')); ?>
                        ...
                        <?php echo e(Form::select('contact_type',[''=>'Choose Client Type','Individual'=>'Individual','Organization'=>'Company/Organization'], null, ['class' => 'form-control multiselect', 'id' => 'contact_type', 'required' => ''])); ?>
							...
							<div class="form-group form-group-default">
								<?php echo Form::label('customer_name', 'Customer Name', array('class'=>'control-label text-danger')); ?>
                     ...
                     <?php if($contact->contact_type == "Individual"): ?>
                        <div class="row">
                           ...
                           <div class="col-md-8">
										<div class="form-group form-group-default">
											<?php echo Form::label('Designation', 'Job Designation', array('class'=>'control-label')); ?>
							...
							<div class="row ">
								<div class="col-md-6">
									<div class="form-group form-group-default">
										...
										<?php echo e(Form::select('groups[]', $category, null, ['class' => 'form-control multiple-select2','multiple' => 'multiple'])); ?>
...
<?php $__env->startSection('scripts'); ?>
	<script>
      ...
      $("#set-post-thumbnail").click(function() {
		...
		$(".multiple-select2").select2().val(<?php echo json_encode($selectedCategory); ?>).trigger('change');
	</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/customers/edit.blade.php ENDPATH**/ ?>