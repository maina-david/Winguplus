<div>
   <div class="row mb-3">
      ...
      <div class="col-md-2">
         ...
         <select wire:model="balance" class="form-control">`
                  ...
                  <?php if($contact->business_code == Auth::user()->business_code): ?>
                     <?php if($contact->customerCode): ?>
                        <tr>
                           ...
                           <td><?php echo $contact->currency; ?><?php echo number_format(Finance::customer_invoices($contact->customerCode)->sum('balance')); ?></td>
                           <td>
                              <div class="btn-group">
                                 ...
                                 <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo e(route('finance.contact.edit',$contact->customerCode)); ?>"><i class="fas fa-edit"></i> Edit</a></li>
                                    <li><a href="<?php echo route('finance.contact.delete',$contact->customerCode); ?>" class="delete"><i class="fal fa-trash-alt"></i> Delete</a></li>
                                 </ul>
                              </div>
                           </td>
                        </tr>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/livewire/finance/customers/index.blade.php ENDPATH**/ ?>