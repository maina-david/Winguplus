...
<?php $__env->startSection('stylesheet'); ?>
   <link rel="stylesheet" href="<?php echo asset('assets/plugins/smartwizard/smart_wizard.css'); ?>" />
<?php $__env->stopSection(); ?>
...
<div id="content" class="content">
   ...
   <!-- end breadcrumb -->
   <!-- begin page-header -->
   <h1 class="page-header"><i class="fal fa-building"></i> Maintenance Request - Edit </h1>
   <div class="row">
      <form action="<?php echo route('property.maintenance.store'); ?>" method="POST" class="form-control-with-bg col-md-12" enctype="multipart/form-data">
         <div id="wizard">         
            <?php echo csrf_field(); ?>
            <!-- begin wizard -->
            <!-- begin wizard-step -->
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                       ...
                                       <?php echo Form::select('property',$properties, null, ['class' => 'form-control multiselect','id' => 'property_select'] ); ?>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                       ...
                                       <?php echo Form::select('priority',['' => 'Choose Priority','Low' => 'Low','Normal' => 'Normal','High' => 'High','Critical' => 'Critical'], null, ['class' => 'form-control multiselect'] ); ?>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                       ...
                                       <?php echo Form::select('status',['' => 'Choose Status','Pending' => 'Pending','In Progress' => 'In Progress','Resolved'  => 'Resolved'], null, ['class' => 'form-control multiselect'] ); ?>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                       ...
                                       <?php echo Form::date('available_date',null, ['class' => 'form-control'] ); ?>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group form-group-default required">
                                       ...
                                       <?php echo Form::text('issue_title', null, ['class' => 'form-control', 'placeholder' => 'Enter issue title'] ); ?>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                       ...
                                       <?php echo Form::select('category',$category, null, ['class' => 'form-control multiselect','id' => 'maintenance_category'] ); ?>
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group required">
                                       ...
                                       <?php echo Form::textarea('issue_details', null, ['class' => 'form-control ckeditor', 'placeholder' => 'Enter issue title'] ); ?>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-12 mt-3" id="service_provider" style="display: none">
                                    <div class="form-group form-group-default required">
                                       ...
                                       <?php echo Form::select('service_provider',$suppliers, null, ['class' => 'form-control multiselect'] ); ?>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                       ...
                                       <?php echo Form::date('initiated_date',null,['class' => 'form-control']); ?>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                       ...
                                       <?php echo Form::date('due_date',null,['class' => 'form-control datepicker']); ?>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                       ...
                                       <?php echo Form::date('started_to_work_date',null,['class' => 'form-control datepicker']); ?>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                       ...
                                       <?php echo Form::date('completed_work_date',null,['class' => 'form-control datepicker']); ?>
...
<?php $__env->startSection('scripts'); ?>
   <script src="<?php echo asset('assets/plugins/smartwizard/jquery.smartWizard.js'); ?>"></script>
   <script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/propertywingu/maintenance/edit.blade.php ENDPATH**/ ?>