      ...
      <form id="expressIncomeForm" action="javascript:void(0)">
         <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <img src="<?php echo url('/'); ?>/public/backend/img/btn-loader.gif" class="saveExpressIncome-load none" alt="" width="15%">
            </div>
         </div>
      </form>
   </div>
</div><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/income/express.blade.php ENDPATH**/ ?>