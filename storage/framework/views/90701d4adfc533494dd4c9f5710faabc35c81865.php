...
<div class="content">
	<!-- begin page-header -->
	<h1 class="page-header"><i class="fab fa-elementor"></i>Update asset type</h1>
	...
	<div class="row">
      ...
      <div class="col-md-6">
         <div class="card">
            ...
            <div class="card-body">
               <?php echo Form::model($edit, ['route' => ['assets.type.update',$edit->type_code], 'method'=>'post','enctype' => 'multipart/form-data']); ?>
                  ...
                  <div class="form-group">
                     <button class="btn btn-pink submit"><i class="fas fa-save"></i> Update type</button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/assets/types/edit.blade.php ENDPATH**/ ?>