<?php $__env->startSection('title','Edit Job Openings | Recruitment | Human Resource'); ?>
         ...
         <div class="col-md-8">
            ...
            <div class="panel panel-inverse">
               <div class="panel-body">
                  <?php echo Form::model($edit, ['route' => ['hrm.recruitment.jobs.update',$edit->code], 'method'=>'post','enctype'=>'multipart/form-data','class' => 'row','autocomplete' => 'off']); ?>
                     ...
                     <div class="col-sm-6">
                        <div class="form-group form-group-default required">
                           ...
                           <?php echo Form::text('location',null, array('class' => 'form-control', 'required' => '')); ?>
                     ...
                     <div class="col-md-6">
                        <div class="form-group form-group-default required">
                           ...
                           <?php echo Form::select('listed',[''=>'Choose','Yes'=>'Yes','No'=>'No'],null,['class'=>'form-control select2','id' => 'listed_options']); ?>

                        </div>
                     </div>
							<div class="col-md-6">
                        <?php if($edit->listed == 'Yes'): ?>
                           <div class="row">
                        <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/hr/recruitment/jobs/edit.blade.php ENDPATH**/ ?>