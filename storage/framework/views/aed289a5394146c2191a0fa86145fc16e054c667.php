<?php $__env->startSection('title','Import Tenant'); ?>
   ...
   <div class="row page-titles mx-0">
      <div class="col-sm-6 p-md-0">
         <div class="welcome-text">
            <h4><i class="fal fa-users-medical"></i> Import Landlord </h4>
         </div>
      </div>
	...
	<div id="content" class="content">
      <div class="row">
         <div class="col-md-12  mb-2">
            <a href="<?php echo url('/'); ?>/public/samples/landlord_import_sample_file.csv" class="btn btn-danger pull-right"><i class="fal fa-file-download"></i> Download Sample</a>
         </div>         
         <div class="col-md-12">
         ...
         <div class="panel-body">
            <div class="row">
               <div class="col-md-4 mtop15">
                  <form action="<?php echo route('landlord.import'); ?>" id="import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                     <?php echo csrf_field(); ?>
                     ...
                     <div class="form-group">
                        <button type="submit" class="btn btn-success submit"><i class="fas fa-save"></i> Import Landlord</button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/propertywingu/landlord/import.blade.php ENDPATH**/ ?>