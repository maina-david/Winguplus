<?php $__env->startSection('title','User Summary'); ?>
   ...
   <div class="row">
      <div class="col-md-12">
         <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
               <a class="nav-link active" href="<?php echo route('app.dashboard.user.summary'); ?>">Employees summary</a>
            </li>
            <li class="nav-item" role="presentation">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/salesflow/dashboard/user-summary.blade.php ENDPATH**/ ?>