...
<?php $__env->startSection('content'); ?>
   ...
   <div class="row">
      <div class="col-md-6">
         <div class="card">
            <div class="card-body">
               <?php echo Form::model($edit, ['route' => ['warehousing.update',$edit->warehouse_code], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-check form-switch">
                           ...
                           <input type="checkbox" class="form-check-input" name="is_main" id="customSwitch1" value="Yes" <?php if($edit->is_main == 'Yes'): ?> checked <?php endif; ?> />
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-check form-switch">
                           <label class="form-check-label mb-50" for="customSwitch4">Is Active</label>
                           <input type="checkbox" class="form-check-input" name="status" id="customSwitch4" value="Active"  <?php if($edit->status == 'Active'): ?> checked <?php endif; ?> />
                        </div>
                     </div>
                  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/salesflow/warehousing/edit.blade.php ENDPATH**/ ?>