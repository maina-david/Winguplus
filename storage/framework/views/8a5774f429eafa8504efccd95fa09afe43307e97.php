						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group form-group-default">
									...
									<?php echo e(Form::select('category[]', $groups, null, ['class' => 'form-control multiselect','multiple' => 'multiple'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/salesflow/suppliers/create.blade.php ENDPATH**/ ?>