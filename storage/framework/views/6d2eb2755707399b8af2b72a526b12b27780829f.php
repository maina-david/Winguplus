<?php $__env->startSection('title','Add Units | Property Wingu'); ?>
...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header"><i class="fal fa-building"></i> <?php echo $property->title; ?> | Add Units </h1>
      <div class="row">
         ...
         <div class="col-md-12">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <?php echo Form::open(array('route' => 'propertywingu.property.units.store','enctype'=>'multipart/form-data','method'=>'post' )); ?>
                     ...
                     <div class="row">
                        <div class="col-md-4">
                           <div class="form-group form-group-default required">
                              <?php echo Form::label('Unit Type', 'Unit Type', array('class'=>'control-label')); ?>
                        ...
                        <div class="col-md-4">
                           <div class="form-group form-group-default required">
                              <?php echo Form::label('Market Price', 'Market Price', array('class'=>'control-label')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/propertywingu/property/units/create.blade.php ENDPATH**/ ?>