<?php $__env->startSection('title','Edit Customer | Sales Flow'); ?>
...
<?php $__env->startSection('content'); ?>
   <div class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><a href="<?php echo route('salesflow.customer.index'); ?>">Customer</a></li>
      ...
      <?php echo Form::model($customer, ['route' => ['salesflow.customer.update',$customer->customer_code], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div class="form-group form-group-default required">
                        <?php echo Form::label('customer_name', 'Customer names', array('class'=>'control-label text-danger')); ?>

                        <?php echo Form::text('customer_name', null, array('class' => 'form-control', 'placeholder' => 'Enter customer name', 'required' => '')); ?>

                     </div>
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              <?php echo Form::label('department', 'VAT Number', array('class'=>'control-label')); ?>

                              <?php echo Form::text('vat_number', null, array('class' => 'form-control', 'placeholder' => 'Enter Number')); ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo Form::time('delivery_time', null, array('class' => 'form-control')); ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo Form::select('route',[],null, array('class' => 'form-control select2')); ?>

                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              <?php echo Form::label('department', 'Zone', array('class'=>'control-label')); ?>

                              <?php echo Form::select('zone',[], null, array('class' => 'form-control select2')); ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo Form::select('region',[], null, array('class' => 'form-control select2')); ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo Form::select('territory',[],null, array('class' => 'form-control select2')); ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo Form::text('latitude', null, array('class' => 'form-control', 'placeholder' => 'Enter Latitude')); ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo Form::text('longitude', null, array('class' => 'form-control', 'placeholder' => 'Enter Longitude')); ?>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div class="form-group form-group-default">
                        ...
                        <?php echo Form::email('email', null, array('class' => 'form-control', 'placeholder' => 'Enter customer email')); ?>
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo Form::number('primary_phone_number', null, array('class' => 'form-control','placeholder' => 'e.x 254 700 000 000')); ?>
                        ...
                        <div class="col-sm-6">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo Form::number('other_phone_number', null, array('class' => 'form-control', 'placeholder' => 'e.x 254 700 000 000')); ?>
                        ...
                        <div class="col-md-12">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo e(Form::select('category[]', [], null, ['class' => 'form-control select2','multiple' => 'multiple'])); ?>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <?php echo Form::textarea('remarks',null,['class'=>'form-control tinymcy', 'size' =>'5x10', 'placeholder'=>'content']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/salesflow/customers/edit.blade.php ENDPATH**/ ?>