<?php $__env->startSection('title','Supplier Category | Point Of Sale'); ?>
      ...
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     <?php echo Form::open(array('route' => 'pos.supplier.groups.store')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/pos/suppliers/groups/index.blade.php ENDPATH**/ ?>