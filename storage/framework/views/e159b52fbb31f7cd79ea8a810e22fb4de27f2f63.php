<?php $__env->startSection('title','PO Settings'); ?>
...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header"><i class="fas fa-tools"></i>  po Settings</h1>
            ...
            <div class="card">
               <div class="card-header">
                  <ul class="nav nav-tabs card-header-tabs">
                     ...
                     <li class="nav-item">
                        <a class="<?php echo e(Nav::isResource('tabs')); ?>" href="<?php echo route('finance.settings.lpo.tabs',$settings->id); ?>">
                     ...
                     <?php if(Request::is('finance/settings/lpo')): ?>
                        <div class="">
                           <?php echo Form::model($settings, ['route' => ['finance.settings.lpo.generated.update',$settings->id], 'method'=>'post',]); ?>
                              ...
                              <div class="form-group">
                                 <label for="">LPO Prefix</label>
                                 <?php echo Form::text('prefix', null, array('class' => 'form-control')); ?>

                              </div>
                              <p class="font-weight-bold"><i class="fas fa-info-circle text-primary"></i> Specify a prefix to dynamically set the Lpo number. The Lpo number will have 2 extra zeros i.e 002.</p>
                              <div class="form-group">
                                 <center><button type="submit" class="btn pink submit"><i class="fas fa-save"></i> Update Information</button></center>
                              </div>
                           <?php echo Form::close(); ?>
                        ...
                        <div class="">
                           <?php echo Form::model($settings, ['route' => ['finance.settings.lpo.tabs.update',$settings->id], 'method'=>'post',]); ?>
                              ...
                              <div class="form-check">
                                 ...
                                 <label class="form-check-label" for="defaultCheckbox">Show Discount tab on Lpo<label>
                              </div><br>
                              <div class="form-check">
                                 ...
                                 <label class="form-check-label" for="defaultCheckbox">Show Tax tab on Lpo<label>
                              </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/subscriptions/settings/index.blade.php ENDPATH**/ ?>