<?php $__env->startSection('title','Product Images | Sales Flow'); ?>
...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><a href="<?php echo route('salesflow.product.index'); ?>">Items</a></li>
         <li class="breadcrumb-item active">Product Images</li>
      </ol>
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header"><i class="fal fa-images"></i> Product Images | <?php echo $product->product_name; ?> </h1>
      <!-- end page-header -->
         ...
         <div class="col-md-9">
            <div class="panel panel-default">
               <div class="panel-heading">
                  <h4 class="panel-title"><?php echo $product->product_name; ?> - Product Images</h4>
               </div>
                                 ...
                                 <td style="width:27%">
                                    <?php if($image->cover == 0): ?>
                                       <center style="float:left;">
                                          ...
                                          <?php echo Form::hidden('product_code', $product->product_code); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/salesflow/products/images.blade.php ENDPATH**/ ?>