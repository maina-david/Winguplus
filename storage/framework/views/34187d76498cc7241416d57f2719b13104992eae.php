         ...
         <div class="row">
            ...
            <div class="col-md-4">
               <h4>
                  ...
                  Supplier :
                     <?php if($details->supplier): ?>
                        <span class="text-primary"><b><?php echo Finance::supplier($details->supplier)->supplierName; ?></b></span>
                     <?php endif; ?><br>
                  Brand :
               ...
               <h4>
                  ...
                  <br><br>
                  Tags <br>
                  <span class="badge badge-warning"><?php echo $details->tag; ?></span>
               </h4>
            </div>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/salesflow/products/details/overview.blade.php ENDPATH**/ ?>