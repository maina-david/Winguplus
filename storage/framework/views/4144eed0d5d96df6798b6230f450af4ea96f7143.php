      ...
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-blue">
            ...
            <div class="stats-info">
               ...
               <p><?php echo $client->symbol; ?><?php echo number_format($outstanding); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-red">
            ...
            <div class="stats-info">
               ...
               <p><?php echo $client->symbol; ?><?php echo number_format($unusedCredits); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-green">
            ...
            <div class="stats-info">
               ...
               <p><?php echo $client->symbol; ?><?php echo number_format($totalIncome); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-yellow">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($projectCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-pink">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($invoiceCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-purple">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($quotesCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-black">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($paymentsCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-orange">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($mailCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-indigo">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($smsCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-aqua">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($taskCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-teal">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($subscriptionsCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-grey">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($assetsCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
      ...
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-purple-darker">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($eventsCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-purple">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($countNotes); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-yellow-darker">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($documentsCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-pink-darker">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($salesOrderCount); ?></p>
            </div>
         </div>
      </div>
      <div class="col-xl-4 col-md-6">
         <div class="widget widget-stats bg-aqua-darker">
            ...
            <div class="stats-info">
               ...
               <p><?php echo number_format($commentCount); ?></p>
            </div>
         </div>
      </div>
   </div>
</div><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/ecommerce/contacts/show.blade.php ENDPATH**/ ?>