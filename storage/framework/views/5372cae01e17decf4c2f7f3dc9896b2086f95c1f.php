	...
	<div id="content" class="content">
		<div class="row">
			<div class="col-md-3">
               ...
               <?php if($client->customer_logo != ""): ?>
						<img src="<?php echo asset('businesses/'.Wingu::business(Auth::user()->businessID)->businessID.'/customer/'.$client->customer_code.'/images/'.$client->customer_logo); ?>" alt="" style="width:90px;height:90px" class="rounded-circle">
					<?php else: ?>
					...
					<a href="<?php echo e(route('finance.contact.edit', $client->cid)); ?>" class="btn btn-success btn-xs waves-effect mb-2 waves-light"><i class="fal fa-edit"></i> Edit</a>
					<a href="<?php echo e(route('finance.customer.send', $client->cid)); ?>" class="btn btn-primary btn-xs waves-effect mb-2 waves-light"><i class="fal fa-paper-plane"></i> Send Email</a>
			...
			<div class="col-md-9">
				<div class="row mb-3">
                  ...
                  <div class="float-right">
							<a href="<?php echo e(route('finance.contact.edit', $client->cid)); ?>" class="btn btn-white"><i class="fas fa-edit"></i> Edit</a>
							<a href="<?php echo e(route('finance.customer.send', $client->cid)); ?>" class="btn btn-white"><i class="fal fa-paper-plane"></i> Send Mail</a>
   						<div class="btn-group">
   						...
   						<div class="btn-group">
								...
								<ul class="dropdown-menu">
									...
									<li class="divider"></li>									
									<li><a href="<?php echo route('finance.contact.delete', $client->cid); ?>"><i class="fas fa-trash"></i> Delete</a></li>
								</ul>
							</div>
                        ...
                        <div class="email-head-subject">
                           <div class="title d-flex align-items-center justify-content-between">
                              <div class="d-flex align-items-center">
                                 <span><?php echo $mail->subject; ?></span>
                              </div>
                           </div>
                        </div>                       
                     </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/ecommerce/contacts/mail/show.blade.php ENDPATH**/ ?>