<div>
   <div class="row">
      <div class="col-md-12">
         <a href="" data-toggle="modal" data-target=".lost" class="btn btn-sm btn-primary pull-right"><i class="fal fa-plus-circle"></i> Record Asset as Missing</a>
      </div>
            ...
            <?php if($editMode == 'on'): ?>
               <div class="modal-content">
                  <div class="modal-header">
                     <h3 class="modal-title" id="exampleModalLabel"><i class="fal fa-tools"></i> Edit Missing Log</h3>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group form-group-default required">
                              <label for="" class="text-danger">Missing date </label>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/livewire/assets/assets/missing.blade.php ENDPATH**/ ?>