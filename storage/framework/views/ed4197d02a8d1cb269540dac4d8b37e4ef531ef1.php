               ...
               <li class="list-group-item">
                  <div class="media">
                     <div class="pull-left">
                        <div class="thumb">
                           <?php if($client->image != ""): ?>
                              <img src="<?php echo asset('businesses/'.Wingu::business()->business_code.'/customer/'.$client->customer_code.'/images/'.$client->image); ?>" alt="" style="width:50px;height:50px" class="rounded-circle">
                           <?php else: ?>
                     ...
                     <div class="media-body">
                        <div class="media-heading">
                           <a href="<?php echo route('finance.customer.mail.details',[$mail->mail_code,$customerCode]); ?>" class="m-r-10"><?php echo $mail->names; ?></a>
                        ...
                        <p class="msg">
                           ...
                           <?php if($mail->view_count): ?>
                              <br>
                              <span class="text-pink"><b>View Date</b>
                                 <br>
                                 <i class="text-primary"><?php echo date('F jS, Y @ h:i:s A',strtotime($mail->date_view)); ?></i>
                              </span>
                              <br>
                              <span class="text-info">View Count : <?php echo $mail->view_count; ?></span>
                           <?php endif; ?>
                        </p>
                     </div>
                  </div>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/contacts/mail/index.blade.php ENDPATH**/ ?>