<?php $__env->startSection('title'); ?>  <?php echo $property->title; ?> | Credit Notes | Edit <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header"><i class="fal fa-home"></i>  <?php echo $property->title; ?> | Credit Notes | Edit</h1>
      <div class="row">
         ...
         <div class="col-md-12">
            <?php echo Form::model($creditnote, ['route' => ['property.creditnote.update',[$property->id,$creditnote->id]], 'method'=>'post']); ?>
                     ...
                     <div class="row">
                        <div class="col-md-3 col-lg-3">
                           <div class="form-group form-group-default">
                              ...
                              <?php echo Form::select('tenantID',$tenants,null,['class'=>'form-control multiselect','id' => 'tenant','required' => '']); ?>
                           ...
                           <div class="form-group">
                              ...
                              <div class="input-group mb-2">
                                 <div class="input-group-prepend">
                                    <div class="input-group-text"><?php echo e($creditnote->creditnote_prefix); ?></div>
                                 </div>
                                 <input type="text" value="<?php echo e($creditnote->creditnote_number); ?>" class="form-control" readonly> 
                              </div>
                           </div>                        
                        </div> 
                        <div class="col-md-3 col-lg-3">
                        ...
                        <div class="col-md-3 col-lg-3">
                           <div class="form-group form-group-default">
                              ...
                              <input type="text" name="title" value="<?php echo $creditnote->title; ?>" class="form-control" autocomplete="off" placeholder = "Enter title">
                           </div>
                        </div>
                        <div class="col-md-3 col-lg-3">
                           <div class="form-group form-group-default required">
                              ...
                              <select name="leaseID" id="leases" class="form-control" required>
                                 <option value="<?php echo $creditnote->leaseID; ?>"><?php echo $tenant->serial; ?></option>
                              </select>
                           </div> 
                        </div>
                     </div>                  
                     ...
                     <div class='row mt-3'>
                        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                           <table class="table table-bordered table-striped" id="creditNoteItems">
                              ...
                              <tbody>
                                 <?php $__currentLoopData = $creditProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="clone-item">
                                       <td>
                                          <textarea type="text" name="product_name[]" class="form-control" id="itemName_0" required><?php echo $products->item_name; ?></textarea>
                                       </td>
                                       <td>
                                          <input type="number" name="qty[]" id="quantity_0" value="<?php echo $products->quantity; ?>" class="form-control changesNo quanyityChange" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required>
                                       </td>
                                       <td>
                                          <input type="number" name="price[]" id="price_0" class="form-control onchange changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="<?php echo $products->price; ?>"  required>
                                       </td> 
                                       <td>
                                          <select name="tax[]" class="form-control changesNo onchange" id="tax_0" autocomplete="off">
                                             <?php if($products->taxrate != ""): ?>
                                                <option value="<?php echo $products->taxrate; ?>" selected><?php echo $products->taxrate; ?>%</option>
                                             <?php else: ?>
                                       ...
                                       <td>
                                          ...
                                          <input type="text" id="totalAmount_0" class="form-control totalSum addNewRow" autocomplete="off" placeholder="Total Amount" step="0.01" value="<?php echo $products->total_amount; ?>" readonly>
                                       </td>
                              ...
                              <tfoot>
                                 <tr>
                                    ...
                                    <td colspan="3">
                                       <h4 class="text-center">
                                          <input readonly type="number" class="form-control" id="subTotal" step="0.01" value="<?php echo $creditnote->sub_total; ?>">
                                       </h4>
                                    </td>
                                 </tr>
                                 <tr id="taxfield">
                                    ...
                                    <td colspan="3">
                                       <h4 class="text-center">
                                          <input readonly type="number" class="form-control" id="taxvalue" step="0.01" value="<?php echo $creditnote->taxvalue; ?>">
                                       </h4>
                                    </td>
                                 </tr>
                                 <tr class="table-default">
                                    ...
                                    <td colspan="3">
                                       <h4 class="text-center">
                                          <input readonly type="number" class="form-control" id="InvoicetotalAmount" placeholder="Total" step="0.01" value="<?php echo $creditnote->total; ?>">
                                       </h4>
                                    </td>
                                 </tr>
                              </tfoot>
               ...
               <div class='row mt-3'>
                  <div class="col-md-6 mt-3">
                     ...
                     <textarea name="customer_note" class="form-control my-editor" rows="8" cols="80"><?php echo $creditnote->customer_note; ?></textarea>
                  </div>
                  <div class="col-md-6 mt-3">
                     <label for="">Terms & Conditions</label>
                     <textarea name="terms" class="form-control my-editor" rows="8" cols="80"><?php echo $creditnote->terms; ?></textarea>
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/propertywingu/accounting/creditnote/edit.blade.php ENDPATH**/ ?>