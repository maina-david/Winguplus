...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item"><?php echo $attribute->name; ?></li>
         <li class="breadcrumb-item active">Edit</li>
      </ol>
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header">Attributes > <?php echo $attribute->name; ?> > Edit</h1>
      <!-- end page-header -->
      ...
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     <?php echo Form::model($edit, ['route' => ['finance.product.attributes.value.update',$edit->id], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/pos/items/attributes/values/edit.blade.php ENDPATH**/ ?>