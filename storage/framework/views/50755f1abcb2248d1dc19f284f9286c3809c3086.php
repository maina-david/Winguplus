      ...
      <ul class="nav">
         <li class="nav-profile">
            <a href="javascript:;" data-toggle="nav-profile">
               ...
               <div class="image">
                  <img src="<?php echo url('/'); ?>/public/img/user/user-13.jpg" alt="" />
               </div>
               <div class="info">
      ...
      <ul class="nav">
         ...
         <li>
            <a href="bootstrap_4.html">
               <div class="icon-img">
                  <img src="<?php echo url('/'); ?>/public/img/logo/logo-bs4.png" alt="" />
                  </div>
...
<div class="sidebar-bg"></div><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/partials/_sidebar.blade.php ENDPATH**/ ?>