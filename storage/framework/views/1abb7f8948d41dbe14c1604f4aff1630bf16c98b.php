<?php $__env->startSection('title','New Lead'); ?>
...
<div class="content">
	...
	<ol class="breadcrumb pull-right">
		...
		<li class="breadcrumb-item"><a href="<?php echo route('crm.customers.index'); ?>">Customer</a></li>
	...
	<?php echo Form::open(array('route' => 'crm.customers.store','enctype'=>'multipart/form-data','data-parsley-validate' => '', 'method'=>'post' )); ?>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group form-group-default required">
						<?php echo Form::label('Customer Type', 'Customer Type', array('class'=>'control-label text-danger')); ?>

						<select name="contact_type" class="form-control select2" id="contact_type" required>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group form-group-default">
								...
								<?php echo e(Form::select('groups[]', $groups, null, ['class' => 'form-control select2','multiple' => 'multiple'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/customers/create.blade.php ENDPATH**/ ?>