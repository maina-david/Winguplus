   ...
   <div class="card">
      ...
      <div class="card-footer text-muted">
         <div class="row">
            ...
            <div class="col-md-4">
               <a href="<?php echo route('crm.customer.notes.delete', $note->note_code); ?>" class="btn btn-sm btn-danger float-right delete"><i class="fas fa-trash"></i> Delete</a>
               <a href="#" data-toggle="modal" data-target="#edit-note-<?php echo $note->note_code; ?>" class="btn btn-sm float-right mr-2 btn-primary"><i class="fas fa-edit"></i> Edit</i></a>
            </div>
         </div>
      </div>
   </div>
   <div class="modal fade" id="edit-note-<?php echo $note->note_code; ?>">
      <div class="modal-dialog modal-lg">
         <?php echo Form::model($note, ['route' => ['finance.customer.notes.update', $note->note_code], 'method'=>'post']); ?>
...
<div class="modal fade" id="add-note">
   <div class="modal-dialog modal-lg">
      <form action="<?php echo route('crm.customer.notes.store'); ?>" method="post">
         <?php echo csrf_field(); ?>
         <div class="modal-content">
            <div class="modal-header">
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/customers/notes.blade.php ENDPATH**/ ?>