...
<head>
   ...
   <title>Quote | <?php echo $details->prefix; ?><?php echo $details->number; ?></title>
         ...
         <div class="col-xs-5">
            <table style="width: 100%">
               <tbody>
                  ...
                  <tr>
                     <th>Issue Date</th>
                     <td class="text-right"><?php echo date('F j, Y',strtotime($details->quote_date)); ?></td>
                  </tr>
                  ...
                  <tbody>
                     <?php if($details->status == 3): ?>
                        <tr class="well" style="padding: 5px">
                           ...
                           <td style="padding: 5px" class="text-right"><strong> <?php echo number_format($details->balance); ?> <?php echo $details->code; ?> </strong></td>
                        </tr>
         ...
         <tbody>
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $count=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr class="item-row">
                  ...
                  <td>
                     <?php echo $details->currency; ?><?php echo e(number_format($product->price,2)); ?>
                  ...
                  <?php if($details->tax_config != 'Exclusive'): ?>
                     <?php if($details->show_tax_tab == 'Yes'): ?>
                        <tr class="well" style="padding: 5px">
                           ...
                           <td style="padding: 5px" class="text-right">
                              <strong>
                                 : <?php echo $details->currency; ?><?php echo number_format($details->tax_value,2); ?>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/templates/bootstrap-3/quotes/quotes.blade.php ENDPATH**/ ?>