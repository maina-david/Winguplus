...
<?php $__env->startSection('content'); ?>
	<div id="content" class="content">
      ...
      <div class="pull-right">
         <a href="<?php echo route('finance.customer.download.sample.import'); ?>" class="btn btn-pink"><i class="fal fa-file-download"></i> Download Sample</a>
      </div>
      <!-- end breadcrumb -->
      <!-- begin page-header -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/contacts/import.blade.php ENDPATH**/ ?>