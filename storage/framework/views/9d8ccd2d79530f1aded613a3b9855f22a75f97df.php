<?php $__env->startSection('title','Product Inventory | Finance'); ?>
         ...
         <div class="panel panel-default">
            <div class="panel-body">
               <div class="col-md-12 mt-3">
                  <?php echo Form::model($product, ['route' => ['salesflow.inventory.settings.update',$productCode],'class' => 'row', 'method'=>'post','enctype'=>'multipart/form-data']); ?>
                           ...
                           <table class="table table-striped">
                              ...
                              <tbody>
                                 <?php $__currentLoopData = $inventories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inventory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <form action="<?php echo route('salesflow.products.inventory.update',[$inventory->id,$productCode]); ?>" method="POST" >
                                       <?php echo csrf_field(); ?>
                                       <tr>
                                          <td>
               ...
               <div class="form-group">
                  ...
                  <select name="outlets[]" id="" class="form-control" multiple required style="width:100%">
                     <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($mainBranch->code != $outlet->code): ?>
                           <option value="<?php echo $outlet->code; ?>"><?php echo $outlet->branch_name; ?></option>
                        <?php endif; ?>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/salesflow/products/inventory.blade.php ENDPATH**/ ?>