<?php $__env->startSection('title','Edit Product | Point Of Sale'); ?>
...
<div id="content" class="content">
   ...
   <!-- end breadcrumb -->
   <!-- begin page-header -->
   <h1 class="page-header"><i class="fal fa-shopping-basket"></i> Edit | <?php echo $product->product_name; ?></h1>
   <!-- end page-header -->
   ...
   <div class="row">
      ...
      <div class="col-md-9">
         <?php echo Form::model($product, ['route' => ['pos.products.update',$productCode], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
               ...
               <div class="panel-body">
                  <div class="col-md-12">
                     ...
                     <div class="form-group form-group-default">
                        ...
                        <?php echo e(Form::select('tags[]',$tags,null,['class' => 'form-control multiple-tag', 'multiple' => 'multiple'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/pos/products/products/edit.blade.php ENDPATH**/ ?>