<?php $__env->startSection('title','Product Price | E-commerce'); ?>
...
<div id="content" class="content">
	...
	<ol class="breadcrumb pull-right">
      ...
      <li class="breadcrumb-item"><a href="<?php echo route('ecommerce.product.index'); ?>">Item</a></li>
	...
	<div class="row">
		...
		<div class="col-md-9">
			<?php if($product->same_price != 'No'): ?>
				<?php echo Form::model($defaultPrice,['route' =>['ecommerce.products.price.update',$defaultPrice->id],'method'=>'post','enctype'=>'multipart/form-data','data-parsley-validate' => '']); ?>
									...
									<table class="table table-striped">
										...
										<tbody>
											<?php $__currentLoopData = $prices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<?php echo Form::model($price,['route' =>['ecommerce.products.price.update',$price->id],'method'=>'post']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/ecommerce/products/price.blade.php ENDPATH**/ ?>