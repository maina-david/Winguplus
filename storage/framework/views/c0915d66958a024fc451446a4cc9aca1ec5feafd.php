         ...
         <tbody>
            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crt => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr role="row" class="odd">
                  ...
                  <td><a href="<?php echo route('job.show',$v->job_code); ?>" class="btn btn-sm btn-pink" target="_blank"><i class="fas fa-eye"></i> view</td>
               </tr>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/customers/projects.blade.php ENDPATH**/ ?>