                              ...
                              <table class="table zi-table financial-comparison table-no-border">
                                 ...
                                 <tbody>
                                       ...
                                       <?php if(Finance::check_expense_per_category_by_period($expCat->category_code,$from,$to) != 0): ?>
                                          <?php $__currentLoopData = Finance::expense_per_category($expCat->category_code,$from,$to); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr class=" balance-tr">
                                                ...
                                                <td class="text-right font-italics"><?php echo $business->currency; ?><?php echo number_format(Finance::expense_per_category_sum($expCat->category_code,$from,$to),2); ?></td>
                                             </tr>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                       <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                       ...
                                       <td class="text-right font-italics"><b><?php echo $business->currency; ?><?php echo number_format($expense,2); ?></b></td>
                                    </tr>
                                    <tr>
                                       <td class="table-bg"><h4><b>Net Profit</b></h4></td>
                                       <td class="table-bg text-right"><h4 class="text-pink font-italics"><b><?php echo $business->currency; ?><?php echo number_format($income - $expense,2); ?></b></h4></td>
                                    </tr>
                                 </tbody>
                              </table>
                           </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/reports/profitandloss/detailed.blade.php ENDPATH**/ ?>