...
<body class="pace-top bg-white">
	...
	<div class="container">
		...
		<div class="row mb-5">
				...
				<div class="card">
					<div class="card-body">
						<div class="signup">
							...
							<h4>New to WinguPlus? <a href="<?php echo e(route('signup.page')); ?>">Create new account</a></h4>
							<?php echo $__env->make('partials._messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
							<form action="<?php echo e(route('login')); ?>" method="post" class="row mt-3" autocomplete="off">
								<?php echo csrf_field(); ?>
								<input autocomplete="off" name="hidden" type="text" style="display:none;">
								<div class="col-md-12">
									<div class="form-group">
                              <label class="control-label">Email </label>
                              <input id="email" type="email" class="form-control form-control-lg" name="email" placeholder="Email Address" value="<?php echo e(old('email')); ?>" required autofocus>
                              ...
                              <?php endif; ?>
								...
								<div class="col-md-12 mt-3">
									<div class="row">
										...
										<div class="col-md-6">
											<center>
												<button type="submit" class="btn btn-pink btn-block btn-lg submit">Sign in</button>
            ...
            <p class="text-center"> Forgot your password? Click <a href="<?php echo e(route('password.request')); ?>">here</a> to Reset.</p>
				<hr>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/auth/login.blade.php ENDPATH**/ ?>