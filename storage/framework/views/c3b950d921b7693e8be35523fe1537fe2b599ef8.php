...
<?php $__env->startSection('title'); ?> Tenants | Edit <?php $__env->stopSection(); ?>
...
<div id="content" class="content">
   ...
   <!-- end breadcrumb -->
   <!-- begin page-header -->
   <h1 class="page-header"><i class="fal fa-users-medical"></i> Tenants | Edit </h1>
	<div class="row">  
      <div class="col-md-12">
         <?php echo $__env->make('partials._messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         <?php echo Form::model($tenant, ['route' => ['tenants.update',$tenant->tenantID],'enctype'=>'multipart/form-data','method'=>'post','autocomplete' => '']); ?>
               ...
               <div class="col-md-6"> 
                  <div class="panel panel-default">
                     <div class="panel-heading">                       
                        <h4 class="panel-title">Tenant Details</h4>
                     </div>
                     <div class="panel-body">
                        <div class="form-group form-group-default">
                           <?php echo Form::label('Client Type', 'Tenant Type', array('class'=>'control-label text-danger')); ?>

                           <?php echo e(Form::select('tenant_type',[''=>'Choose Tenant Type','Individual'=>'Individual','Organization'=>'Company/Organization'], null, ['class' => 'form-control', 'id' => 'tenantType', 'required' => ''])); ?>

                        </div>
                        <div class="form-group form-group-default">
                           <?php echo Form::label('tenant_name', 'Tenant Name', array('class'=>'control-label text-danger')); ?>

                           <?php echo Form::text('tenant_name', null, array('class' => 'form-control', 'placeholder' => 'Tenant Names', 'required' => '')); ?>

                        </div>
                        <?php if($tenant->tenant_type == "Individual"): ?>
                           <div class="row">
                              <div class="col-sm-6">
                                 <div class="form-group form-group-default">
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group form-group-default">
                                    <?php echo Form::label('Identification Number', 'Date of Birth', array('class'=>'control-label')); ?>
                        ...
                        <?php endif; ?>
                        <div class="form-group form-group-default">
                           <?php echo Form::label('contact_email', 'Contact Email', array('class'=>'control-label')); ?>
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">                        
                        ...
                        <div class="row">
                           <div class="col-sm-6">
                              <div class="form-group form-group-default">
                                 <?php echo Form::label('primary_phone_number', 'Phone Number', array('class'=>'control-label text-danger')); ?>

                                 <?php echo Form::text('phone_number', null, array('class' => 'form-control','placeholder' => 'e.x 0700 000 000','required' => '')); ?>
                     ...
                     <div class="tab-pane active" id="other_details">
                        <div class="row ">
                           ...
                           <div class="col-md-6">
                              ...
                              <?php if($tenant->image != ""): ?>
                                 <img alt="" class="img-circle" src="<?php echo asset('businesses/'.Wingu::business(Auth::user()->businessID)->businessID .'/property/tenant/'. $tenant->tenant_code .'/images/'.$tenant->image); ?>" style="width:50%">
                              <?php endif; ?>
                           </div>
                        </div>
                     </div>
            ...
            <div class="row mb-5">
               <div class="col-md-12">
                  <button type="submit" class="btn btn-success submit"><i class="fas fa-save"></i> Update Tenant</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/propertywingu/tenants/edit.blade.php ENDPATH**/ ?>