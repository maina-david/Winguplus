<?php $__env->startSection('title','Events | Edit | Human Resource'); ?>
   ...
   <div id="content" class="content">
      ...
      <div class="row">
         <div class="col-md-8">
            <div class="card">
               <div class="card-body">
                  <?php echo Form::model($edit, ['route' => ['hrm.events.update',$edit->event_code], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/hr/events/edit.blade.php ENDPATH**/ ?>