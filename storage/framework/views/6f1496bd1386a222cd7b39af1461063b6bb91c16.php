...
<?php $__env->startSection('title'); ?> Suppliers Create <?php $__env->stopSection(); ?>
...
<div id="content" class="content">
   ...
   <!-- end breadcrumb -->
   <!-- begin page-header -->
   <h1 class="page-header"><i class="fal fa-users-cog"></i> Suppliers - Create</h1>
   <!-- end breadcrumb -->
	<div class="row"> 
      <?php echo $__env->make('partials._messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php echo Form::open(array('route' => 'property.supplier.store','enctype'=>'multipart/form-data','class' => 'col-md-12', 'method'=>'post' )); ?>
               ...
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     ...
                     <div class="form-group form-group-default required">
                        ...
                        <?php echo Form::text('supplierName', null, array('class' => 'form-control', 'placeholder' => 'Supplier Name')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/propertywingu/suppliers/create.blade.php ENDPATH**/ ?>