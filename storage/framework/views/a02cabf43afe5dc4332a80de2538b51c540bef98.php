   ...
   <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="widget-list-item">
               ...
               <div class="widget-list-action">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     <li><a href="<?php echo asset('businesses/'.Wingu::business(Auth::user()->business_code)->business_code.'/customer/'.$lead->reference_number.'/'.$document->file_name); ?>" target="_blank">View document</a></li>
                     <li><a href="<?php echo route('crm.leads.documents.delete',[$document->id,$code]); ?>" class="delete">Delete</a></li>
                  </ul>
               </div>
            </div>
      ...
      <div class="modal fade" id="update-document-<?php echo $document->id; ?>" tabindex="-1" role="dialog">
         <div class="modal-dialog modal-lg">
            <?php echo Form::model($document, ['route' => ['crm.leads.documents.update', $document->id], 'method'=>'post', 'autocomplete'=>'off','enctype' => 'multipart/form-data']); ?>
...
<div class="modal fade" id="add-document" tabindex="-1" role="dialog">
   <div class="modal-dialog modal-lg">
      <?php echo Form::open(array('route' => 'crm.leads.documents.store','method' =>'post','autocomplete'=>'off','enctype' => 'multipart/form-data')); ?>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/leads/documents/index.blade.php ENDPATH**/ ?>