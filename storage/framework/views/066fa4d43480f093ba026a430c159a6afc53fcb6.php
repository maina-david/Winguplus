		...
		<div class="row">
			<div class="col-md-3">
               ...
               <?php if($client->image != ""): ?>
					...
					<a href="<?php echo e(route('crm.customer.send', $client->cid)); ?>" class="btn btn-primary btn-xs waves-effect mb-2 waves-light"><i class="fal fa-paper-plane"></i> Send Email</a>
			...
			<div class="col-md-9">
				<div class="row mb-3">
                  ...
                  <div class="float-right">
							<a href="<?php echo e(route('crm.customers.edit', $client->cid)); ?>" class="btn btn-white"><i class="fal fa-edit"></i> Edit</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/customers/mail/show.blade.php ENDPATH**/ ?>