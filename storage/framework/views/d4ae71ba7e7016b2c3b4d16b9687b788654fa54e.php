<?php $__env->startSection('title'); ?> <?php echo $property->title; ?> | Invoice Details <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header"><i class="fal fa-home"></i> <?php echo $property->title; ?> | Billing | Invoices</h1>
      <div class="row">
         ...
         <div class="col-md-12"> 
            <div class="row mb-3">
               <span class="col-md-12">
                  <?php if (app('laratrust')->isAbleTo('update-invoice')) : ?>
                     <a href="<?php echo route('property.invoice.edit',[$propertyID,$invoiceID]); ?>" class="btn btn-sm btn-primary m-b-10 p-l-5">
            ...
            <div class="panel">
               <div class="panel-body">         
                  <?php echo $__env->make('templates.'.$business->template_name.'.invoice.property.preview', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
               </div>
            </div>
         </div>
         
         <form action="<?php echo route('property.invoice.payment',[$propertyID,$invoiceID]); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group form-group-default required">
                                 ...
                                 <input type="text" value="<?php echo $invoice->balance; ?>" name="amount" class="form-control" placeholder="Enter amount" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/propertywingu/accounting/invoices/show.blade.php ENDPATH**/ ?>