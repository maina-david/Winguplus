<div>
   <div wire:ignore.self class="modal right fade" id="eventEdit" tabindex="-1" role="dialog" aria-labelledby="eventEdit" data-keyboard="false" data-backdrop="static">
...
unset($__errorArgs, $__bag); ?>
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-6">
                           <div class="form-group form-group-default">
                              ...
                              <input type="time" wire:model.defer="end_time" class="form-control">
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="modal-footer modal-footer-fixed ">
               <button class="btn btn-secondary" wire:click="close()">Cancel</button>
               <button class="btn btn-primary" wire:click.prevent="update_event()"><i class="fas fa-save"></i> Save Information</button>
            </div>
         </div>
      </div>
   </div>
</div>
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/livewire/crm/leads/events/edit.blade.php ENDPATH**/ ?>