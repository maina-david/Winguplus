         ...
         <div class="panel panel-default">
            <div class="panel-body">
               <div class="col-md-12 mt-3">
                  <?php echo Form::model($product, ['route' => ['finance.inventory.settings.update',$productCode],'class' => 'row', 'method'=>'post','enctype'=>'multipart/form-data']); ?>
                           ...
                           <table class="table table-striped">
                              ...
                              <tbody>
                                 <?php $__currentLoopData = $inventories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inventory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <form action="<?php echo route('finance.inventory.update',[$inventory->id,$productCode]); ?>" method="POST" >
                                       <?php echo csrf_field(); ?>
                                       <tr>
                                          <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/products/inventory.blade.php ENDPATH**/ ?>