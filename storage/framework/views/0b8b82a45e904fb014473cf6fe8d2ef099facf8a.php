<?php $__env->startSection('title','Product Category | Point Of Sale'); ?>
      ...
      <div class="row">
                        ...
                        <tbody>
                           <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $count=>$all): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                                 ...
                                 <td>
                                    <a href="<?php echo e(route('pos.product.category.edit', $all->category_code)); ?>" class="btn btn-primary btn-sm"><i class="far fa-edit"></i></a>
                                    <a href="<?php echo route('pos.product.category.destroy', $all->category_code); ?>" class="btn btn-danger btn-sm delete"><i class="fas fa-trash"></i></a>
                                 </td>
                              </tr>
         ...
         <div class="col-md-6">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     <?php echo Form::open(array('route' => 'pos.product.category.store')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/pos/products/category/index.blade.php ENDPATH**/ ?>