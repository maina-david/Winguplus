...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header">Edit Attributes</h1>
      <!-- end page-header -->
                           ...
                           <tbody>
                              <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <tr>
                                    ...
                                    <td><?php echo Finance::products_by_brand_count($attribute->id); ?></td>
                                    <td>
            ...
            <div class="col-md-6">
               <div class="panel panel-default">
                  <div class="panel-heading">
                     <h4 class="panel-title">Update Attributes</h4>
                  </div>
                  <div class="panel-body">
                     <div class="panel-body">
                        <?php echo Form::model($edit, ['route' => ['finance.product.attributes.update',$edit->id], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
                           ...
                           <div class="form-group mt-4">
                              <center>
                                    <button type="submit" class="btn btn-pink submit"><i class="fas fa-save"></i> Update Attributes</button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/pos/items/attributes/edit.blade.php ENDPATH**/ ?>