<?php $__env->startSection('title','Create Exit Details'); ?>
			...
			<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
				<div class="inner" style="transform: translateY(0px); opacity: 1;">					 
					<ul class="breadcrumb">
						...
						<li><a href="#" class="active">Create Exit Details</a></li>
					</ul>
				</div>
			</div>
		</div> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main-template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/hr/exit/create.blade.php ENDPATH**/ ?>