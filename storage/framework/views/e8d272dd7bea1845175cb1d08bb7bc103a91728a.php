<?php $__env->startSection('title','Create Agents'); ?>
...
<div id="content" class="content">
   ...
   <div class="card card-default">
      <div class="card-body">
         ...
         <form class="row" method="post" action="<?php echo route('property.agents.store'); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="col-sm-6">
            ...
            <div class="col-md-12 mt-3">
               <center>
                  ...
                  <img src="<?php echo asset('assets/app/img/btn-loader.gif'); ?>" class="submit-load none" alt="" width="15%">
               </center>
            </div>
         </form>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/propertywingu/agents/create.blade.php ENDPATH**/ ?>