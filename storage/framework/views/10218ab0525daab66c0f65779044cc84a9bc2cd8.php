<div class="col-md-3">
    <div class="hpanel">
        <div class="panel-body">
            <div class="dropdown">
                <button type="button" class="dropdown-toggle btn btn-success btn-block" data-toggle="modal" data-target="#myModal" ><i class="fa fa-cloud-upload" aria-hidden="true"></i> Upload Files</button>
            </div>
            <ul class="h-list m-t">
                <li class="active"><a href="#"><i class="fa fa-folder"></i> Create Folder</a></li>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/partials/gallery-menu.blade.php ENDPATH**/ ?>