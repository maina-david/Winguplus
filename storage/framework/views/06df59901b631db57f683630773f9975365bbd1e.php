<?php $__env->startSection('title','Digital Marketing Channels'); ?>
...
<?php $__env->startSection('content'); ?>
	<div id="content" class="content">
      ...
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header">Edit Channels</h1>
      <!-- end page-header -->
      ...
      <div class="row">
         ...
         <div class="col-md-5">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <?php echo Form::model($edit, ['route' => ['crm.channel.update',$edit->id], 'method'=>'post','class' => '']); ?>

                     <?php echo csrf_field(); ?>
                     <input type="hidden" name="accountID" value="<?php echo $accountID; ?>" required>  
                     <div class="form-group form-group-default">
                        <label for="">Medium</label>
                        <?php echo Form::select('mediumID',$mediums,null,['class'=>'form-control multiselect']); ?>
                     ...
                     <div class="form-group">
                        <center>
                           <button type="submit" class="btn btn-pink submit"><i class="fas fa-save"></i> Update Channel</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/social/channels/edit.blade.php ENDPATH**/ ?>