...
<?php $__env->startSection('content'); ?>
   ...
   <div class="card">
      <div class="card-body">
         <?php echo Form::model($edit, ['route' => ['survey.update',$edit->code], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
            ...
            <div class="row">
               ...
               <div class="col-md-12 mt-1 mb-2">
                  <div class="panel-body">
                     <div class="form-group">
                        ...
                        <?php echo Form::textarea('description',null,['class'=>'form-control', 'size' => '6x6', 'placeholder'=>'caption']); ?>
               ...
               <div class="col-md-12">
                  <div class="form-group">
                     <center>
                        <?php echo Form::submit('Update survey',array('class' =>'btn btn-success btn-sm submit')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/salesflow/survey/survey/edit.blade.php ENDPATH**/ ?>