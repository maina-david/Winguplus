...
<div class="content">
	...
	<ol class="breadcrumb pull-right">
		...
		<li class="breadcrumb-item"><a href="<?php echo route('pos.supplier.index'); ?>">Supplier</a></li>
		<li class="breadcrumb-item active">Create</li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header"><i class="fal fa-users-cog"></i> Add Supplier </h1>
	<?php echo $__env->make('partials._messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<?php echo Form::open(array('route' => 'pos.supplier.store','enctype'=>'multipart/form-data','data-parsley-validate' => '', 'method'=>'post' )); ?>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group form-group-default required">
							<?php echo Form::label('Supplier', 'Supplier Name', array('class'=>'control-label text-danger')); ?>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group form-group-default">
									...
									<?php echo e(Form::select('category[]', $groups, null, ['class' => 'form-control select2','multiple' => 'multiple'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/pos/suppliers/create.blade.php ENDPATH**/ ?>