         ...
         <tbody>
            <?php $__currentLoopData = $creditnotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crt => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr role="row" class="odd">
                  ...
                  <td>
                     <b><?php echo Finance::creditnote()->prefix; ?>00<?php echo $v->creditnote_number; ?></b>
                  </td>
                  ...
                  <td>
                     <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                           <li><a href="<?php echo e(route('finance.creditnote.show', $v->id)); ?>"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;&nbsp; View</a></li>
                           <li><a href="<?php echo route('finance.creditnote.edit', $v->id); ?>"><i class="fas fa-edit"></i>&nbsp;&nbsp; Edit</a></li>
                           <li><a href="<?php echo route('finance.creditnote.delete', $v->id); ?>"><i class="fas fa-trash-alt"></i>&nbsp;&nbsp; Delete</a></li>
                        </ul>
                     </div>
                  </td>
               </tr>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/subscriptions/customer/creditnotes.blade.php ENDPATH**/ ?>