      ...
      <div class="row">
                        ...
                        <?php $__currentLoopData = $pipelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $count=>$pipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <tr>
                              ...
                              <td>
                                 ...
                                 <a href="<?php echo route('crm.pipeline.show',$pipe->pipeline_code); ?>" class="btn btn-sm btn-primary">View</a>
         ...
         <div class="col-md-6">
            <div class="card">
               ...
               <div class="card-body">
                  <?php echo Form::model($edit, ['route' => ['crm.pipeline.update', $edit->pipeline_code], 'method'=>'post', 'autocomplete' => 'off']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/deals/pipelines/pipeline/edit.blade.php ENDPATH**/ ?>