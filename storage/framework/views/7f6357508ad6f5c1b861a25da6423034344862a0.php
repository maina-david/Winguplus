			...
			<li>
				...
				<div class="timeline-body">
					...
					<div class="timeline-footer">
						<a href="<?php echo route('finance.contact.comments.delete', $comment->id); ?>" class="mr-2 btn btn-sm btn-danger"><i class="fas fa-trash"></i> delete</a>
					</div>
				</div>
				<!-- end timeline-body -->
			</li>	
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/subscriptions/customer/comments.blade.php ENDPATH**/ ?>