<div>
   ...
   <div class="panel panel-default">
      ...
      <div class="panel-body">
               ...
               <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($contact->business_code == Auth::user()->business_code): ?>
                     <tr >
                        ...
                        <td><?php echo date('d F, Y', strtotime($contact->customer_date)); ?></td>
                        <td>
                           <a href="<?php echo e(route('pos.contact.edit', $contact->customer_code)); ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                           <a href="<?php echo route('pos.contact.delete', $contact->customer_code); ?>" class="btn btn-sm btn-danger delete"><i class="fal fa-trash-alt"></i></a>
                        </td>
                     </tr>
                  <?php endif; ?>
         ...
         <?php echo $contacts->links('pagination.custom'); ?>

      </div>
   </div>
</div>
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/livewire/pos/customers.blade.php ENDPATH**/ ?>