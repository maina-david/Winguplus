...
<head>
	<meta charset="utf-8" />
	<title>Limitless ERP | 504 Error Page</title>
	<meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport" />
	<meta content="" name="description" />
	<meta content="" name="author" />
	
	<!-- ================== BEGIN BASE CSS STYLE ================== -->
	<link href="<?php echo url('/'); ?>/public/fonts/main/bundled.fonts.css" rel="stylesheet">
	<link href="<?php echo url('/'); ?>/public/app/plugins/jquery-ui/jquery-ui.min.css" rel="stylesheet" />
	<link href="<?php echo url('/'); ?>/public/app/plugins/bootstrap/4.1.0/css/bootstrap.min.css" rel="stylesheet" />
	<link href="<?php echo url('/'); ?>/public/fonts/fontawesome-5.8/css/all.css" rel="stylesheet" />
	<link href="<?php echo url('/'); ?>/public/app/css/default/style.min.css" rel="stylesheet" />
	<link href="<?php echo url('/'); ?>/public/app/css/default/style-responsive.min.css" rel="stylesheet" />
	<link href="<?php echo url('/'); ?>/public/app/css/default/theme/default.css" rel="stylesheet" id="theme" />
	<!-- ================== END BASE CSS STYLE ================== -->
</head>
<body class="pace-top">
	<!-- begin #page-loader -->
		...
		<div class="error">
			...
			<div class="error-content">
               ...
               <ul style="list-style: none;">
                  <li><a href="<?php echo url('/'); ?>">LimitlessERP home page</a></li>
...
</html><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/errors/504.blade.php ENDPATH**/ ?>