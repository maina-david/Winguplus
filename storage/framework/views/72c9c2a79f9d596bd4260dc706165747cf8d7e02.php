...
<?php $__env->startSection('content'); ?>
	<div id="content" class="content">
      ...
      <!-- end breadcrumb -->
      <!-- begin page-header -->
      <h1 class="page-header">Mediums</h1>
      <!-- end page-header -->
      ...
      <div class="row">
         ...
         <form class="col-md-6" method="POST" action="<?php echo route('crm.medium.store'); ?>">
            <div class="panel panel-default">
               <div class="panel-heading">
                  <h4 class="panel-title">Add Mediums</h4>
               </div>
               <div class="panel-body">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="form-group">
                     <center>
                        <button type="submit" class="btn btn-pink submit"><i class="fas fa-save"></i> Save Medium</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/social/medium/index.blade.php ENDPATH**/ ?>