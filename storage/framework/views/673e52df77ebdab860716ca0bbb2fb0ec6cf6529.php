<?php $__env->startSection('title','Landlords | Edit'); ?>
...
<?php $__env->startSection('content'); ?>
   <div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         <li class="breadcrumb-item"><a href="<?php echo route('landlord.index'); ?>">Landlords</a></li>
      ...
      <!-- end breadcrumb -->
      <?php echo Form::model($landlord, ['route' => ['landlord.update',$landlord->customerID], 'method'=>'post','enctype'=>'multipart/form-data']); ?>
                  ...
                  <div class="tab-pane active" id="other_details">
                     <div class="row ">
                        ...
                        <div class="col-md-6">
                           ...
                           <?php if($landlord->image != ""): ?>
                              <img alt="<?php echo $landlord->customer_name; ?>" class="img-circle" src="<?php echo asset('businesses/'.Wingu::business(Auth::user()->businessID)->businessID .'/customer/'.$landlord->customer_code); ?>/images/<?php echo $landlord->image; ?>" style="width:50%">
                           <?php endif; ?>
                        </div>
                     </div>
                  </div>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="" rowspan="" headers="">
                                       <div class="btn-group sm-m-t-10">
                                          <a class="btn btn-danger delete" href="<?php echo e(route('landlordperson.delete',$cp->id)); ?>"><i class="fas fa-trash-alt"></i></a>
                                       </div>
                                    </td>
                                 </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/propertywingu/landlord/edit.blade.php ENDPATH**/ ?>