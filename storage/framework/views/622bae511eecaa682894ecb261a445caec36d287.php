...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo url('/'); ?>/resources/views/templates/invoices/default/style.css" media="all" />
   </head>
   <body>
      <div id="page-wrap">
         <table width="100%">
...
</html><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/templates/default/invoice.blade.php ENDPATH**/ ?>