                     ...
                     <div class="email-head">
                        <div class="email-head-subject">
                           <div class="title d-flex align-items-center justify-content-between">
                              ...
                              <div class="icons">
                                 <a href="#" class="icon"><i class="fas fa-trash"></i></a>
                              </div>
                           </div>
                        </div>
                        <div class="email-head-sender d-flex align-items-center justify-content-between flex-wrap">
                           <div class="d-flex align-items-center">
                              <div class="avatar">
                                 <?php if($lead->image != ""): ?>
                                    <img class="rounded-circle user-avatar-md" alt="" class="<?php echo $lead->names; ?>" src="<?php echo asset('businesses/'.$lead->business_code.'/clients/'.$lead->customer_code.'/images/'.$lead->image); ?>" style="width:50px;height:50px">
                                 <?php else: ?>
                                    <img src="https://ui-avatars.com/api/?name=<?php echo $lead->customer_name; ?>&rounded=true&size=50 alt="" class="rounded-circle user-avatar-md">
                                 <?php endif; ?>
                              </div>
                              <div class="sender d-flex align-items-center">
                                 <a href="#"><?php echo $mail->name; ?></a>
                              </div>
                           </div>
                           <div class="date"><?php echo date('F d, Y @ h:i:s A', strtotime($mail->created_at)); ?></div>
                        </div>
                     </div>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/leads/mail/details.blade.php ENDPATH**/ ?>