	...
	<div id="content" class="content">
      ...
      <div class="col-md-12 mb-3">
         <div class="row">
            ...
            <div class="col-md-4">
               <a href="<?php echo route('finance.report.receivables.balance.print',[$to,$from]); ?>" target="_blank" class="btn btn-pink pull-right"><i class="fas fa-file-pdf"></i> Export in pdf</a>
               <a href="<?php echo route('finance.report.receivables.balance.print',[$to,$from]); ?>" target="_blank" class="btn btn-pink pull-right mr-2"><i class="fas fa-print"></i> Print</a>
                     ...
                     <?php $__currentLoopData = $balances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($balance->total > 0): ?>
                           <tr>
                              ...
                              <td><center><i><b><?php echo $balance->currency; ?> <?php echo number_format($balance->total); ?> </b></i></center></td>
                           </tr>
                        <?php endif; ?>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     <tr>
                        <td><b>Total</b></td>
                        <td><center><i><b><?php echo Wingu::business()->currency; ?><?php echo number_format($balances->sum('total')); ?></b></i></center></td>
                     </tr>
                  </tbody>
               </table>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/reports/receivables/customer_balances.blade.php ENDPATH**/ ?>