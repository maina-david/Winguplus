...
<?php $__env->startSection('content'); ?>
   ...
   <div id="content" class="content">
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item active">Leads by Status</li>
      </ol>

      <!-- begin page-header -->
      <h1 class="page-header"><i class="fal fa-exclamation-circle"></i> Leads by Status | <?php echo $statusRequest; ?> | <?php echo date('F j, Y', strtotime($start)); ?> to <?php echo date('F j, Y', strtotime($end)); ?></h1>
      <?php echo $__env->make('partials._messages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <div class="row">
         <div class="col-md-8">
            <form action="<?php echo route('crm.reports.leads.status.filter'); ?>" method="GET" class="row" autocomplete="off">
               <div class="col-md-3">
                  <div class="form-group">
                     <?php echo Form::select('status',$status,null,['class'=>'form-control multiselect']); ?>
         ...
         <div class="col-md-4">
            <a href="<?php echo route('crm.reports.leads.status.export',[$statusValue,$start,$end]); ?>" class="float-right btn btn-pink"><i class="fal fa-file-excel"></i> Export to csv</a>
         </div>
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                           ...
                           <tr>
                              ...
                              <td>
                                 <?php if($lead->industryID != ""): ?>
                                    <?php echo Wingu::industry($lead->industryID)->name; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/reports/leads/status.blade.php ENDPATH**/ ?>