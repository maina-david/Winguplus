<?php $__env->startSection('title','winguPlus Applications'); ?>
                  ...
                  <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                           ...
                           <a href="<?php echo route('application.remove.cart',$item->module_code); ?>" class="delete"><span class="badge badge-danger">Remove</span></a>
                        </div>
               ...
               <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($app->id != 9): ?>
                     <?php if($app->status == 15 || $app->status == 24): ?>
                        <?php if(Wingu::check_business_modules($app->module_code) == 0): ?>
                           <div class="col-md-4">
                              <div class="card">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/wingu/applications.blade.php ENDPATH**/ ?>