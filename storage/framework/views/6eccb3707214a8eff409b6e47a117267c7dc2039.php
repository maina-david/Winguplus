         ...
         <div class="col-xl-3 col-md-6">
            <div class="widget widget-stats bg-blue">
               ...
               <div class="stats-content">
                  ...
                  <div class="stats-number"><?php echo $currency; ?><?php echo number_format($todaySales); ?></div>
         ...
         <div class="col-xl-3 col-md-6">
            <div class="widget widget-stats bg-black">
               ...
               <div class="stats-content">
                  ...
                  <div class="stats-number"><?php echo $currency; ?><?php echo number_format($monthSales); ?></div>
                  <div class="stats-progress progress">
                     <div class="progress-bar" style="width:100%;"></div>
                  </div>
                  <div class="stats-desc"><a href="<?php echo route('sales.history'); ?>" class="text-white">view sales</a></div>
         ...
         <div class="col-xl-3 col-md-6">
            <div class="widget widget-stats bg-green">
               ...
               <div class="stats-content">
                  ...
                  <div class="stats-number"><?php echo $currency; ?><?php echo number_format($averageSale); ?></div>
                  <div class="stats-progress progress">
                     <div class="progress-bar" style="width:100%;"></div>
                  </div>
                  <div class="stats-desc"><a href="<?php echo route('sales.history'); ?>" class="text-white">view sales</a></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/ecommerce/dashboard/dashboard.blade.php ENDPATH**/ ?>