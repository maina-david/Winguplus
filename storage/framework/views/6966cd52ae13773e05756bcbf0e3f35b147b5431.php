<?php $__env->startSection('title','My Dashboard | Customer relationship management'); ?>
      ...
      <div class="row">
         <div class="col-md-6">
            <div class="card" style="height: 550px">
               ...
               <div class="card-body">
                  <img src="<?php echo asset('assets/img/filter.png'); ?>" alt="">
               </div>
            </div>
         </div>
         <div class="col-md-6">
            <div class="card" style="height: 550px">
               ...
               <div class="card-body">
                  <img src="<?php echo asset('assets/img/sumamount.png'); ?>" alt="" class="img-responsive">
               </div>
            </div>
         </div>
         <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/crm/dashboard/dashboard.blade.php ENDPATH**/ ?>