	...
	<div id="content" class="content">
		<div class="row">
			<div class="col-md-3">
               ...
               <?php if($client->image != ""): ?>
						<img src="<?php echo asset('businesses/'.Wingu::business(Auth::user()->business_code)->business_code.'/customer/'.$client->customer_code.'/images/'.$client->image); ?>" alt="" style="width:90px;height:90px" class="rounded-circle">
					<?php else: ?>
					...
					<a href="<?php echo e(route('finance.contact.edit', $customerCode)); ?>" class="btn btn-success btn-xs waves-effect mb-2 waves-light"><i class="fal fa-edit"></i> Edit</a>
					<?php if(Wingu::business()->plan != 1): ?>
						<a href="<?php echo route('finance.customer.mail',$customerCode); ?>" class="btn btn-primary btn-xs waves-effect mb-2 waves-light"><i class="fal fa-paper-plane"></i> Send Email</a>
					<?php endif; ?>
					<a href="<?php echo route('finance.contact.delete', $customerCode); ?>" class="btn btn-danger btn-xs waves-effect mb-2 waves-light delete"><i class="fas fa-trash"></i> Delete</a>
				</div>
			...
			<div class="col-md-9">
				<div class="row mb-3">
                  ...
                  <div class="float-right">
							<a href="<?php echo e(route('finance.contact.edit', $customerCode)); ?>" class="btn btn-white"><i class="fas fa-edit"></i> Edit</a>
							<?php if(Wingu::business()->plan != 1): ?>
								<a href="<?php echo e(route('finance.customer.send', $customerCode)); ?>" class="btn btn-white"><i class="fal fa-paper-plane"></i> Send Mail</a>
							<?php endif; ?>
   						<div class="btn-group">
   						...
   						<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<?php if(Wingu::business()->plan != 1): ?>
										<li><a href="<?php echo route('finance.customer.sms',$customerCode); ?>"><i class="fal fa-sms"></i> SMS</a></li>
										<li><a href="<?php echo route('finance.customer.mail',$customerCode); ?>"><i class="fal fa-paper-plane"></i> Mail</a></li>
									<?php endif; ?>
									<li class="divider"></li>
									<li><a href="<?php echo route('finance.customer.notes',$customerCode); ?>"><i class="fal fa-sticky-note"></i> Notes</a></li>
									<li><a href="<?php echo route('finance.customer.events',$customerCode); ?>"><i class="fal fa-calendar-alt"></i> Meeting</a></li>
									<li><a href="<?php echo route('finance.customer.calllog',$customerCode); ?>"><i class="fal fa-phone-office"></i> Call log</a></li>
									<li class="divider"></li>
									<li><a href="<?php echo route('finance.contact.delete', $customerCode); ?>" class="delete"><i class="fas fa-trash"></i> Delete</a></li>
								</ul>
							</div>
							<?php if(Wingu::business()->plan != 1): ?>
								<a href="<?php echo route('finance.customer.documents',$customerCode); ?>" class="btn btn-white"><i class="fal fa-folder"></i> Documents</a>
							<?php endif; ?>
                  </div>
					</div>
				</div>
            ...
            <!-- creditnote -->
				...
				<!-- subscription -->
				<?php if(Request::is('finance/customer/'.$customerCode.'/subscriptions')): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/contacts/view.blade.php ENDPATH**/ ?>