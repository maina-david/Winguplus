<div>
   <div class="row">
      <div class="col-md-12">
         <a href="" data-toggle="modal" data-target=".disposed" class="btn btn-sm btn-primary pull-right"><i class="fal fa-plus-circle"></i> Record Asset As Dispose</a>
      </div>
            ...
            <tbody>
               <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $count=>$event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                     ...
                     <th>
                        <?php echo date('F jS, Y', strtotime($event->action_date)); ?>

                     </th>
                     <th>
                        <?php echo $event->action_to; ?>
            ...
            <?php if($editMode == 'on'): ?>
               <div class="modal-content">
                  <div class="modal-header">
                     <h3 class="modal-title" id="exampleModalLabel"><i class="fal fa-dumpster"></i> Edit Dispose Log</h3>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group form-group-default required">
                              <label for="" class="text-danger">Dispose date </label>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/livewire/assets/assets/dispose.blade.php ENDPATH**/ ?>