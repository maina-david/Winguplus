...
} elseif ($_instance->childHasBeenRendered('yIwkWA6')) {
    $componentId = $_instance->getRenderedChildComponentId('yIwkWA6');
    $componentTag = $_instance->getRenderedChildComponentTagName('yIwkWA6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yIwkWA6');
} else {
    $response = \Livewire\Livewire::mount('finance.suppliers.suppliers');
    $html = $response->html();
    $_instance->logRenderedChild('yIwkWA6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
   </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/app/finance/suppliers/index.blade.php ENDPATH**/ ?>