<div>
   <div class="row">
      ...
      <div class="col-md-12 mb-3">
         <div class="row">
            <div class="col-md-10">
               <h4 class="font-weight-bold"><i class="fal fa-check-square"></i> Job Tasks | <a href="<?php echo route('job.dashboard',$this->jobCode); ?>"><?php echo $job->job_title; ?></a> </h4>
            </div>
            <div class="col-md-2">
      ...
      <?php if($sections->count() > 0): ?>
         <div class="col-md-12">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
               <li class="nav-item">
                  <a class="nav-link active" href="<?php echo route('job.task',$this->jobCode); ?>">General</a>
               </li>
               <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li class="nav-item">
                     <a class="nav-link" href="<?php echo route('job.task.section',[$this->jobCode,$sec->section_code,Helper::seoUrl($sec->title)]); ?>"><?php echo $sec->title; ?></a>
                  </li>
...
<?php /**PATH /var/www/winguplus/cloud.winguplus.com/resources/views/livewire/jobs/job/tasks.blade.php ENDPATH**/ ?>